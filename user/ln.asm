...
main(int argc, char *argv[])
{
  ...
  14:	82058593          	add	a1,a1,-2016 # 830 <malloc+0x102>
  18:	4509                	li	a0,2
  ...
  52:	7fa58593          	add	a1,a1,2042 # 848 <malloc+0x11a>
  56:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2ea:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffebed>
 2ec:	07b2                	sll	a5,a5,0xc
}
 2ee:	4388                	lw	a0,0(a5)
 2f0:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	4d250513          	add	a0,a0,1234 # 8c0 <digits>
 3f6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	37470713          	add	a4,a4,884 # 868 <malloc+0x13a>
 ...
 584:	340b8b93          	add	s7,s7,832 # 8c0 <digits>
 ...
 5da:	28a90913          	add	s2,s2,650 # 860 <malloc+0x132>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 77e:	c8690913          	add	s2,s2,-890 # 1400 <freep>
  if(p == (char*)-1)
 782:	5afd                	li	s5,-1
 ...
 792:	c8278793          	add	a5,a5,-894 # 1410 <base>

...
wc(int fd, char *name)
{
  ...
  3c:	918a0a13          	add	s4,s4,-1768 # 950 <malloc+0x10a>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	8ca50513          	add	a0,a0,-1846 # 970 <malloc+0x12a>
  ...
  d8:	88c50513          	add	a0,a0,-1908 # 960 <malloc+0x11a>
...
main(int argc, char *argv[])
{
 ...
 15a:	80258593          	add	a1,a1,-2046 # 958 <malloc+0x112>
 15e:	4501                	li	a0,0
 ...
 17a:	80a50513          	add	a0,a0,-2038 # 980 <malloc+0x13a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50a:	4f250513          	add	a0,a0,1266 # 9f8 <digits>
 50e:	883a                	mv	a6,a4
 510:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 608:	00271793          	sll	a5,a4,0x2
 60c:	00000717          	auipc	a4,0x0
 610:	39470713          	add	a4,a4,916 # 9a0 <malloc+0x15a>
 ...
 69c:	360b8b93          	add	s7,s7,864 # 9f8 <digits>
 ...
 6f2:	2aa90913          	add	s2,s2,682 # 998 <malloc+0x152>
        while(*s != 0){
...
{
 78e:	711d                	add	sp,sp,-96
 790:	ec06                	sd	ra,24(sp)
 792:	e822                	sd	s0,16(sp)
 794:	1000                	add	s0,sp,32
 796:	e40c                	sd	a1,8(s0)
...
malloc(uint nbytes)
{
 ...
 896:	bae90913          	add	s2,s2,-1106 # 1440 <freep>
  if(p == (char*)-1)
 89a:	5afd                	li	s5,-1
 ...
 8aa:	daa78793          	add	a5,a5,-598 # 1650 <base>
 ...
 914:	c798                	sw	a4,8(a5)
        p += p->s.size;
 916:	02071693          	sll	a3,a4,0x20
 91a:	01c6d713          	srl	a4,a3,0x1c

...
wc(int fd, char *name)
{
  ...
  32:	442d8d93          	add	s11,s11,1090 # 1470 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  3c:	928a0a13          	add	s4,s4,-1752 # 960 <malloc+0x104>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  8e:	3e648493          	add	s1,s1,998 # 1470 <buf>
  ...
  aa:	8da50513          	add	a0,a0,-1830 # 980 <malloc+0x124>
  ...
  d8:	89c50513          	add	a0,a0,-1892 # 970 <malloc+0x114>
...
main(int argc, char *argv[])
{
 ...
 15a:	81258593          	add	a1,a1,-2030 # 968 <malloc+0x10c>
 15e:	4501                	li	a0,0
 ...
 17a:	81a50513          	add	a0,a0,-2022 # 990 <malloc+0x134>
...
ugetpid(void)
{
 ...
 418:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffe98d>
 41a:	07b2                	sll	a5,a5,0xc
}
 41c:	4388                	lw	a0,0(a5)
 41e:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 520:	4ec50513          	add	a0,a0,1260 # a08 <digits>
 524:	883a                	mv	a6,a4
 ...
 568:	fc040793          	add	a5,s0,-64
 56c:	00e78933          	add	s2,a5,a4
 570:	fff78993          	add	s3,a5,-1
 574:	99ba                	add	s3,s3,a4
 576:	377d                	addw	a4,a4,-1
 578:	1702                	sll	a4,a4,0x20
 57a:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 612:	f9d9079b          	addw	a5,s2,-99
 616:	0ff7f713          	zext.b	a4,a5
 61a:	12eb6163          	bltu	s6,a4,73c <vprintf+0x192>
 61e:	00271793          	sll	a5,a4,0x2
 622:	00000717          	auipc	a4,0x0
 626:	38e70713          	add	a4,a4,910 # 9b0 <malloc+0x154>
 ...
 6b2:	35ab8b93          	add	s7,s7,858 # a08 <digits>
 6b6:	03c9d793          	srl	a5,s3,0x3c
 ...
 6ca:	0992                	sll	s3,s3,0x4
 6cc:	397d                	addw	s2,s2,-1
 ...
 708:	2a490913          	add	s2,s2,676 # 9a8 <malloc+0x14c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8ac:	bb890913          	add	s2,s2,-1096 # 1460 <freep>
  if(p == (char*)-1)
 8b0:	5afd                	li	s5,-1
 ...
 8c0:	db478793          	add	a5,a5,-588 # 1670 <base>
 ...
 92a:	c798                	sw	a4,8(a5)
        p += p->s.size;
 92c:	02071693          	sll	a3,a4,0x20
 930:	01c6d713          	srl	a4,a3,0x1c

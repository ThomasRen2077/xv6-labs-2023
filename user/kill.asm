...
main(int argc, char **argv)
{
  ...
  50:	7d458593          	add	a1,a1,2004 # 820 <malloc+0x102>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	4ba50513          	add	a0,a0,1210 # 898 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e8:	35c70713          	add	a4,a4,860 # 840 <malloc+0x122>
 ...
 574:	328b8b93          	add	s7,s7,808 # 898 <digits>
 ...
 5ca:	27290913          	add	s2,s2,626 # 838 <malloc+0x11a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 76e:	c7690913          	add	s2,s2,-906 # 13e0 <freep>
  if(p == (char*)-1)
 772:	5afd                	li	s5,-1
 ...
 782:	c7278793          	add	a5,a5,-910 # 13f0 <base>

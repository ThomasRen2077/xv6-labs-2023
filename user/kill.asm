...
main(int argc, char **argv)
{
  ...
  50:	7f458593          	add	a1,a1,2036 # 840 <malloc+0x10c>
  54:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 2f0:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffebed>
 2f2:	07b2                	sll	a5,a5,0xc
}
 2f4:	4388                	lw	a0,0(a5)
 2f6:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f8:	4c450513          	add	a0,a0,1220 # 8b8 <digits>
 3fc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fe:	36670713          	add	a4,a4,870 # 860 <malloc+0x12c>
 ...
 5e0:	27c90913          	add	s2,s2,636 # 858 <malloc+0x124>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 784:	c8090913          	add	s2,s2,-896 # 1400 <freep>
  if(p == (char*)-1)
 788:	5afd                	li	s5,-1
 ...
 798:	c7c78793          	add	a5,a5,-900 # 1410 <base>

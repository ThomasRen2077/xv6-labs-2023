...
main(int argc, char *argv[])
{
  ...
  44:	81058593          	add	a1,a1,-2032 # 850 <malloc+0x10a>
  48:	4509                	li	a0,2
  ...
  62:	80a58593          	add	a1,a1,-2038 # 868 <malloc+0x122>
  66:	4509                	li	a0,2
...
ugetpid(void)
{
 ...
 302:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffebed>
 304:	07b2                	sll	a5,a5,0xc
}
 306:	4388                	lw	a0,0(a5)
 308:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	4e250513          	add	a0,a0,1250 # 8e8 <digits>
 40e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 510:	38470713          	add	a4,a4,900 # 890 <malloc+0x14a>
 ...
 59c:	350b8b93          	add	s7,s7,848 # 8e8 <digits>
 ...
 5f2:	29a90913          	add	s2,s2,666 # 888 <malloc+0x142>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 796:	c6e90913          	add	s2,s2,-914 # 1400 <freep>
  if(p == (char*)-1)
 79a:	5afd                	li	s5,-1
 ...
 7aa:	c6a78793          	add	a5,a5,-918 # 1410 <base>

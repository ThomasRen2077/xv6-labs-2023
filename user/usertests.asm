...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	12250513          	add	a0,a0,290 # 6160 <malloc+0x104>
      46:	00006097          	auipc	ra,0x6
      4a:	f5e080e7          	jalr	-162(ra) # 5fa4 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	8b078793          	add	a5,a5,-1872 # b908 <uninit>
      60:	0000e697          	auipc	a3,0xe
      64:	fb868693          	add	a3,a3,-72 # e018 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	10050513          	add	a0,a0,256 # 6180 <malloc+0x124>
      88:	00006097          	auipc	ra,0x6
      8c:	f1c080e7          	jalr	-228(ra) # 5fa4 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0f050513          	add	a0,a0,240 # 6198 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0f250513          	add	a0,a0,242 # 61b8 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0ba50513          	add	a0,a0,186 # 61a0 <malloc+0x144>
      ee:	00006097          	auipc	ra,0x6
      f2:	eb6080e7          	jalr	-330(ra) # 5fa4 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0c650513          	add	a0,a0,198 # 61c8 <malloc+0x16c>
     10a:	00006097          	auipc	ra,0x6
     10e:	e9a080e7          	jalr	-358(ra) # 5fa4 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0c450513          	add	a0,a0,196 # 61f0 <malloc+0x194>
     134:	00006097          	auipc	ra,0x6
     138:	b48080e7          	jalr	-1208(ra) # 5c7c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0b050513          	add	a0,a0,176 # 61f0 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0ac58593          	add	a1,a1,172 # 6200 <malloc+0x1a4>
     15c:	00006097          	auipc	ra,0x6
     160:	af0080e7          	jalr	-1296(ra) # 5c4c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	08850513          	add	a0,a0,136 # 61f0 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	08c58593          	add	a1,a1,140 # 6208 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	05c50513          	add	a0,a0,92 # 61f0 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	04650513          	add	a0,a0,70 # 6210 <malloc+0x1b4>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	dd2080e7          	jalr	-558(ra) # 5fa4 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	fbc50513          	add	a0,a0,-68 # 6238 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	fa8a8a93          	add	s5,s5,-88 # 6238 <malloc+0x1dc>
      int cc = write(fd, buf, sz);
     298:	0000ea17          	auipc	s4,0xe
     29c:	d80a0a13          	add	s4,s4,-640 # e018 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f3650513          	add	a0,a0,-202 # 6248 <malloc+0x1ec>
     31a:	00006097          	auipc	ra,0x6
     31e:	c8a080e7          	jalr	-886(ra) # 5fa4 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	f3450513          	add	a0,a0,-204 # 6268 <malloc+0x20c>
     33c:	00006097          	auipc	ra,0x6
     340:	c68080e7          	jalr	-920(ra) # 5fa4 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f2250513          	add	a0,a0,-222 # 6280 <malloc+0x224>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	f0e98993          	add	s3,s3,-242 # 6280 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	ec250513          	add	a0,a0,-318 # 6280 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e3258593          	add	a1,a1,-462 # 6208 <malloc+0x1ac>
    ...
    printf("write failed\n");
     ...
     3f0:	eb450513          	add	a0,a0,-332 # 62a0 <malloc+0x244>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	bb0080e7          	jalr	-1104(ra) # 5fa4 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	e8250513          	add	a0,a0,-382 # 6288 <malloc+0x22c>
     40e:	00006097          	auipc	ra,0x6
     412:	b96080e7          	jalr	-1130(ra) # 5fa4 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	e6850513          	add	a0,a0,-408 # 6288 <malloc+0x22c>
     428:	00006097          	auipc	ra,0x6
     42c:	b7c080e7          	jalr	-1156(ra) # 5fa4 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	e3c50513          	add	a0,a0,-452 # 6280 <malloc+0x224>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d60a0a13          	add	s4,s4,-672 # 62b0 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	cbc50513          	add	a0,a0,-836 # 62b8 <malloc+0x25c>
     604:	00006097          	auipc	ra,0x6
     608:	9a0080e7          	jalr	-1632(ra) # 5fa4 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	cb650513          	add	a0,a0,-842 # 62d0 <malloc+0x274>
     622:	00006097          	auipc	ra,0x6
     626:	982080e7          	jalr	-1662(ra) # 5fa4 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	cc850513          	add	a0,a0,-824 # 6300 <malloc+0x2a4>
     640:	00006097          	auipc	ra,0x6
     644:	964080e7          	jalr	-1692(ra) # 5fa4 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	cde50513          	add	a0,a0,-802 # 6330 <malloc+0x2d4>
     65a:	00006097          	auipc	ra,0x6
     65e:	94a080e7          	jalr	-1718(ra) # 5fa4 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	cd050513          	add	a0,a0,-816 # 6340 <malloc+0x2e4>
     678:	00006097          	auipc	ra,0x6
     67c:	92c080e7          	jalr	-1748(ra) # 5fa4 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b6:	cbea0a13          	add	s4,s4,-834 # 6370 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6ba:	00006a97          	auipc	s5,0x6
     6be:	b4ea8a93          	add	s5,s5,-1202 # 6208 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	c1a50513          	add	a0,a0,-998 # 6378 <malloc+0x31c>
     766:	00006097          	auipc	ra,0x6
     76a:	83e080e7          	jalr	-1986(ra) # 5fa4 <printf>
      exit(1);
     76e:	4505                	li	a0,1
     ...
     780:	c1450513          	add	a0,a0,-1004 # 6390 <malloc+0x334>
     784:	00006097          	auipc	ra,0x6
     788:	820080e7          	jalr	-2016(ra) # 5fa4 <printf>
      exit(1);
     78c:	4505                	li	a0,1
     ...
     79a:	b9a50513          	add	a0,a0,-1126 # 6330 <malloc+0x2d4>
     79e:	00006097          	auipc	ra,0x6
     7a2:	806080e7          	jalr	-2042(ra) # 5fa4 <printf>
      exit(1);
     7a6:	4505                	li	a0,1
     ...
     7b4:	c1050513          	add	a0,a0,-1008 # 63c0 <malloc+0x364>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	7ec080e7          	jalr	2028(ra) # 5fa4 <printf>
      exit(1);
     7c0:	4505                	li	a0,1
     ...
     7d2:	c0a50513          	add	a0,a0,-1014 # 63d8 <malloc+0x37c>
     7d6:	00005097          	auipc	ra,0x5
     7da:	7ce080e7          	jalr	1998(ra) # 5fa4 <printf>
      exit(1);
     7de:	4505                	li	a0,1
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	9dc58593          	add	a1,a1,-1572 # 6200 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	9b050513          	add	a0,a0,-1616 # 61f0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	98450513          	add	a0,a0,-1660 # 61f0 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	97050513          	add	a0,a0,-1680 # 61f0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	baa58593          	add	a1,a1,-1110 # 6468 <malloc+0x40c>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	8f050513          	add	a0,a0,-1808 # 61f0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	ac450513          	add	a0,a0,-1340 # 6408 <malloc+0x3ac>
     94c:	00005097          	auipc	ra,0x5
     950:	658080e7          	jalr	1624(ra) # 5fa4 <printf>
    exit(1);
     954:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	ac850513          	add	a0,a0,-1336 # 6428 <malloc+0x3cc>
     968:	00005097          	auipc	ra,0x5
     96c:	63c080e7          	jalr	1596(ra) # 5fa4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     970:	8652                	mv	a2,s4
     972:	85d6                	mv	a1,s5
     974:	00006517          	auipc	a0,0x6
     978:	ac450513          	add	a0,a0,-1340 # 6438 <malloc+0x3dc>
     97c:	00005097          	auipc	ra,0x5
     980:	628080e7          	jalr	1576(ra) # 5fa4 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	ac850513          	add	a0,a0,-1336 # 6458 <malloc+0x3fc>
     998:	00005097          	auipc	ra,0x5
     99c:	60c080e7          	jalr	1548(ra) # 5fa4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a0:	8652                	mv	a2,s4
     9a2:	85d6                	mv	a1,s5
     9a4:	00006517          	auipc	a0,0x6
     9a8:	a9450513          	add	a0,a0,-1388 # 6438 <malloc+0x3dc>
     9ac:	00005097          	auipc	ra,0x5
     9b0:	5f8080e7          	jalr	1528(ra) # 5fa4 <printf>
    exit(1);
     9b4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	aae50513          	add	a0,a0,-1362 # 6470 <malloc+0x414>
     9ca:	00005097          	auipc	ra,0x5
     9ce:	5da080e7          	jalr	1498(ra) # 5fa4 <printf>
    exit(1);
     9d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	ab050513          	add	a0,a0,-1360 # 6490 <malloc+0x434>
     9e8:	00005097          	auipc	ra,0x5
     9ec:	5bc080e7          	jalr	1468(ra) # 5fa4 <printf>
    exit(1);
     9f0:	4505                	li	a0,1
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a9c50513          	add	a0,a0,-1380 # 64b0 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	aac98993          	add	s3,s3,-1364 # 64d8 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	adca8a93          	add	s5,s5,-1316 # 6510 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	a3650513          	add	a0,a0,-1482 # 64b0 <malloc+0x454>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     a98:	58458593          	add	a1,a1,1412 # e018 <buf>
  ...
  if(unlink("small") < 0){
     ...
     aba:	9fa50513          	add	a0,a0,-1542 # 64b0 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	9d850513          	add	a0,a0,-1576 # 64b8 <malloc+0x45c>
     ae8:	00005097          	auipc	ra,0x5
     aec:	4bc080e7          	jalr	1212(ra) # 5fa4 <printf>
    exit(1);
     af0:	4505                	li	a0,1
     ...
     b02:	9ea50513          	add	a0,a0,-1558 # 64e8 <malloc+0x48c>
     b06:	00005097          	auipc	ra,0x5
     b0a:	49e080e7          	jalr	1182(ra) # 5fa4 <printf>
      exit(1);
     b0e:	4505                	li	a0,1
     ...
     b20:	a0450513          	add	a0,a0,-1532 # 6520 <malloc+0x4c4>
     b24:	00005097          	auipc	ra,0x5
     b28:	480080e7          	jalr	1152(ra) # 5fa4 <printf>
      exit(1);
     b2c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	a1050513          	add	a0,a0,-1520 # 6548 <malloc+0x4ec>
     b40:	00005097          	auipc	ra,0x5
     b44:	464080e7          	jalr	1124(ra) # 5fa4 <printf>
    exit(1);
     b48:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	a1450513          	add	a0,a0,-1516 # 6568 <malloc+0x50c>
     b5c:	00005097          	auipc	ra,0x5
     b60:	448080e7          	jalr	1096(ra) # 5fa4 <printf>
    exit(1);
     b64:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	a1050513          	add	a0,a0,-1520 # 6580 <malloc+0x524>
     b78:	00005097          	auipc	ra,0x5
     b7c:	42c080e7          	jalr	1068(ra) # 5fa4 <printf>
    exit(1);
     b80:	4505                	li	a0,1
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	9fe50513          	add	a0,a0,-1538 # 65a0 <malloc+0x544>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     bba:	46290913          	add	s2,s2,1122 # e018 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	9ac50513          	add	a0,a0,-1620 # 65a0 <malloc+0x544>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     c0c:	41090913          	add	s2,s2,1040 # e018 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	96c50513          	add	a0,a0,-1684 # 65a8 <malloc+0x54c>
     c44:	00005097          	auipc	ra,0x5
     c48:	360080e7          	jalr	864(ra) # 5fa4 <printf>
    exit(1);
     c4c:	4505                	li	a0,1
     ...
     c5e:	96e50513          	add	a0,a0,-1682 # 65c8 <malloc+0x56c>
     c62:	00005097          	auipc	ra,0x5
     c66:	342080e7          	jalr	834(ra) # 5fa4 <printf>
      exit(1);
     c6a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	97a50513          	add	a0,a0,-1670 # 65f0 <malloc+0x594>
     c7e:	00005097          	auipc	ra,0x5
     c82:	326080e7          	jalr	806(ra) # 5fa4 <printf>
    exit(1);
     c86:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca6:	8fe50513          	add	a0,a0,-1794 # 65a0 <malloc+0x544>
     ...
     cd2:	94250513          	add	a0,a0,-1726 # 6610 <malloc+0x5b4>
     cd6:	00005097          	auipc	ra,0x5
     cda:	2ce080e7          	jalr	718(ra) # 5fa4 <printf>
        exit(1);
     cde:	4505                	li	a0,1
     ...
     cf0:	94c50513          	add	a0,a0,-1716 # 6638 <malloc+0x5dc>
     cf4:	00005097          	auipc	ra,0x5
     cf8:	2b0080e7          	jalr	688(ra) # 5fa4 <printf>
      exit(1);
     cfc:	4505                	li	a0,1
     ...
     d0e:	94650513          	add	a0,a0,-1722 # 6650 <malloc+0x5f4>
     d12:	00005097          	auipc	ra,0x5
     d16:	292080e7          	jalr	658(ra) # 5fa4 <printf>
      exit(1);
     d1a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	95250513          	add	a0,a0,-1710 # 6678 <malloc+0x61c>
     d2e:	00005097          	auipc	ra,0x5
     d32:	276080e7          	jalr	630(ra) # 5fa4 <printf>
    exit(1);
     d36:	4505                	li	a0,1
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	93c50513          	add	a0,a0,-1732 # 6690 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	95458593          	add	a1,a1,-1708 # 66c0 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	90850513          	add	a0,a0,-1784 # 6690 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	8f250513          	add	a0,a0,-1806 # 6690 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	8dc50513          	add	a0,a0,-1828 # 6690 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	94058593          	add	a1,a1,-1728 # 6708 <malloc+0x6ac>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de8:	23458593          	add	a1,a1,564 # e018 <buf>
     dec:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     e34:	86050513          	add	a0,a0,-1952 # 6690 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	85050513          	add	a0,a0,-1968 # 66a0 <malloc+0x644>
     e58:	00005097          	auipc	ra,0x5
     e5c:	14c080e7          	jalr	332(ra) # 5fa4 <printf>
    exit(1);
     e60:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	85c50513          	add	a0,a0,-1956 # 66c8 <malloc+0x66c>
     e74:	00005097          	auipc	ra,0x5
     e78:	130080e7          	jalr	304(ra) # 5fa4 <printf>
    exit(1);
     e7c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	86050513          	add	a0,a0,-1952 # 66e8 <malloc+0x68c>
     e90:	00005097          	auipc	ra,0x5
     e94:	114080e7          	jalr	276(ra) # 5fa4 <printf>
    exit(1);
     e98:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	86c50513          	add	a0,a0,-1940 # 6710 <malloc+0x6b4>
     eac:	00005097          	auipc	ra,0x5
     eb0:	0f8080e7          	jalr	248(ra) # 5fa4 <printf>
    exit(1);
     eb4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	87050513          	add	a0,a0,-1936 # 6730 <malloc+0x6d4>
     ec8:	00005097          	auipc	ra,0x5
     ecc:	0dc080e7          	jalr	220(ra) # 5fa4 <printf>
    exit(1);
     ed0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	87450513          	add	a0,a0,-1932 # 6750 <malloc+0x6f4>
     ee4:	00005097          	auipc	ra,0x5
     ee8:	0c0080e7          	jalr	192(ra) # 5fa4 <printf>
    exit(1);
     eec:	4505                	li	a0,1
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	78058593          	add	a1,a1,1920 # 66c0 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	81858593          	add	a1,a1,-2024 # 6778 <malloc+0x71c>
     f68:	00006517          	auipc	a0,0x6
     f6c:	80850513          	add	a0,a0,-2040 # 6770 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f80:	7f450513          	add	a0,a0,2036 # 6770 <malloc+0x714>
     f84:	00005097          	auipc	ra,0x5
     f88:	cf8080e7          	jalr	-776(ra) # 5c7c <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	7e250513          	add	a0,a0,2018 # 6770 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	7d450513          	add	a0,a0,2004 # 6778 <malloc+0x71c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     fc0:	05c58593          	add	a1,a1,92 # e018 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	79c58593          	add	a1,a1,1948 # 6778 <malloc+0x71c>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	78650513          	add	a0,a0,1926 # 6778 <malloc+0x71c>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c82080e7          	jalr	-894(ra) # 5c7c <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	76e58593          	add	a1,a1,1902 # 6770 <malloc+0x714>
    100a:	00005517          	auipc	a0,0x5
    100e:	76e50513          	add	a0,a0,1902 # 6778 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	75258593          	add	a1,a1,1874 # 6770 <malloc+0x714>
    1026:	00006517          	auipc	a0,0x6
    102a:	85a50513          	add	a0,a0,-1958 # 6880 <malloc+0x824>
    ...
    104c:	73850513          	add	a0,a0,1848 # 6780 <malloc+0x724>
    1050:	00005097          	auipc	ra,0x5
    1054:	f54080e7          	jalr	-172(ra) # 5fa4 <printf>
    exit(1);
    1058:	4505                	li	a0,1
    ...
    1068:	73450513          	add	a0,a0,1844 # 6798 <malloc+0x73c>
    106c:	00005097          	auipc	ra,0x5
    1070:	f38080e7          	jalr	-200(ra) # 5fa4 <printf>
    exit(1);
    1074:	4505                	li	a0,1
    ...
    1084:	73050513          	add	a0,a0,1840 # 67b0 <malloc+0x754>
    1088:	00005097          	auipc	ra,0x5
    108c:	f1c080e7          	jalr	-228(ra) # 5fa4 <printf>
    exit(1);
    1090:	4505                	li	a0,1
    ...
    10a0:	73450513          	add	a0,a0,1844 # 67d0 <malloc+0x774>
    10a4:	00005097          	auipc	ra,0x5
    10a8:	f00080e7          	jalr	-256(ra) # 5fa4 <printf>
    exit(1);
    10ac:	4505                	li	a0,1
    ...
    10bc:	74850513          	add	a0,a0,1864 # 6800 <malloc+0x7a4>
    10c0:	00005097          	auipc	ra,0x5
    10c4:	ee4080e7          	jalr	-284(ra) # 5fa4 <printf>
    exit(1);
    10c8:	4505                	li	a0,1
    ...
    10d8:	74450513          	add	a0,a0,1860 # 6818 <malloc+0x7bc>
    10dc:	00005097          	auipc	ra,0x5
    10e0:	ec8080e7          	jalr	-312(ra) # 5fa4 <printf>
    exit(1);
    10e4:	4505                	li	a0,1
    ...
    10f4:	74050513          	add	a0,a0,1856 # 6830 <malloc+0x7d4>
    10f8:	00005097          	auipc	ra,0x5
    10fc:	eac080e7          	jalr	-340(ra) # 5fa4 <printf>
    exit(1);
    1100:	4505                	li	a0,1
    ...
    1110:	74c50513          	add	a0,a0,1868 # 6858 <malloc+0x7fc>
    1114:	00005097          	auipc	ra,0x5
    1118:	e90080e7          	jalr	-368(ra) # 5fa4 <printf>
    exit(1);
    111c:	4505                	li	a0,1
    ...
    112c:	76050513          	add	a0,a0,1888 # 6888 <malloc+0x82c>
    1130:	00005097          	auipc	ra,0x5
    1134:	e74080e7          	jalr	-396(ra) # 5fa4 <printf>
    exit(1);
    1138:	4505                	li	a0,1
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	74e98993          	add	s3,s3,1870 # 68a8 <malloc+0x84c>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	72250513          	add	a0,a0,1826 # 68b8 <malloc+0x85c>
    119e:	00005097          	auipc	ra,0x5
    11a2:	e06080e7          	jalr	-506(ra) # 5fa4 <printf>
      exit(1);
    11a6:	4505                	li	a0,1
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	6dca0a13          	add	s4,s4,1756 # 68d8 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	68a50513          	add	a0,a0,1674 # 68d8 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	62250513          	add	a0,a0,1570 # 68e0 <malloc+0x884>
    12c6:	00005097          	auipc	ra,0x5
    12ca:	cde080e7          	jalr	-802(ra) # 5fa4 <printf>
    exit(1);
    12ce:	4505                	li	a0,1
    ...
    12e2:	62250513          	add	a0,a0,1570 # 6900 <malloc+0x8a4>
    12e6:	00005097          	auipc	ra,0x5
    12ea:	cbe080e7          	jalr	-834(ra) # 5fa4 <printf>
      exit(1);
    12ee:	4505                	li	a0,1
    ...
    12fe:	62650513          	add	a0,a0,1574 # 6920 <malloc+0x8c4>
    1302:	00005097          	auipc	ra,0x5
    1306:	ca2080e7          	jalr	-862(ra) # 5fa4 <printf>
      exit(1);
    130a:	4505                	li	a0,1
...
0000000000001314 <pgbug>:
{
  ...
  exec(big, argv);
    ...
    1326:	07e48493          	add	s1,s1,126 # a3a0 <big>
...
000000000000134c <badarg>:
{
    ...
    135c:	35048493          	add	s1,s1,848 # c350 <uninit+0xa48>
    argv[0] = (char*)0xffffffff;
    1360:	597d                	li	s2,-1
    1362:	02095913          	srl	s2,s2,0x20
    exec("echo", argv);
    1366:	00005997          	auipc	s3,0x5
    136a:	e3298993          	add	s3,s3,-462 # 6198 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	78878793          	add	a5,a5,1928 # 7b78 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    142a:	4da78793          	add	a5,a5,1242 # a900 <big.0>
    142e:	0000a697          	auipc	a3,0xa
    1432:	4d268693          	add	a3,a3,1234 # b900 <big.0+0x1000>
      big[i] = 'x';
    ...
    1448:	4a078e23          	sb	zero,1212(a5) # b900 <big.0+0x1000>
    char *args2[] = { big, big, big, 0 };
    144c:	00007797          	auipc	a5,0x7
    1450:	17478793          	add	a5,a5,372 # 85c0 <malloc+0x2564>
    ...
    1474:	d2850513          	add	a0,a0,-728 # 6198 <malloc+0x13c>
    ...
    148c:	54050513          	add	a0,a0,1344 # 69c8 <malloc+0x96c>
    1490:	00005097          	auipc	ra,0x5
    1494:	b14080e7          	jalr	-1260(ra) # 5fa4 <printf>
      exit(1);
    1498:	4505                	li	a0,1
    ...
    14ac:	49850513          	add	a0,a0,1176 # 6940 <malloc+0x8e4>
    14b0:	00005097          	auipc	ra,0x5
    14b4:	af4080e7          	jalr	-1292(ra) # 5fa4 <printf>
    exit(1);
    14b8:	4505                	li	a0,1
    ...
    14cc:	49850513          	add	a0,a0,1176 # 6960 <malloc+0x904>
    14d0:	00005097          	auipc	ra,0x5
    14d4:	ad4080e7          	jalr	-1324(ra) # 5fa4 <printf>
    exit(1);
    14d8:	4505                	li	a0,1
    ...
    14ee:	49650513          	add	a0,a0,1174 # 6980 <malloc+0x924>
    14f2:	00005097          	auipc	ra,0x5
    14f6:	ab2080e7          	jalr	-1358(ra) # 5fa4 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    ...
    150e:	49e50513          	add	a0,a0,1182 # 69a8 <malloc+0x94c>
    1512:	00005097          	auipc	ra,0x5
    1516:	a92080e7          	jalr	-1390(ra) # 5fa4 <printf>
    exit(1);
    151a:	4505                	li	a0,1
    ...
    1528:	90450513          	add	a0,a0,-1788 # 6e28 <malloc+0xdcc>
    152c:	00005097          	auipc	ra,0x5
    1530:	a78080e7          	jalr	-1416(ra) # 5fa4 <printf>
    exit(1);
    1534:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1572:	48250513          	add	a0,a0,1154 # 69f0 <malloc+0x994>
    1576:	00005097          	auipc	ra,0x5
    157a:	a2e080e7          	jalr	-1490(ra) # 5fa4 <printf>
    exit(1);
    157e:	4505                	li	a0,1
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159c:	c5850513          	add	a0,a0,-936 # 61f0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15ce:	c26a0a13          	add	s4,s4,-986 # 61f0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	47ea8a93          	add	s5,s5,1150 # 6a50 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    164e:	3d650513          	add	a0,a0,982 # 6a20 <malloc+0x9c4>
    1652:	00005097          	auipc	ra,0x5
    1656:	952080e7          	jalr	-1710(ra) # 5fa4 <printf>
    exit(1);
    165a:	4505                	li	a0,1
    ...
    166a:	3d250513          	add	a0,a0,978 # 6a38 <malloc+0x9dc>
    166e:	00005097          	auipc	ra,0x5
    1672:	936080e7          	jalr	-1738(ra) # 5fa4 <printf>
        exit(1);
    1676:	4505                	li	a0,1
    ...
    1688:	3dc50513          	add	a0,a0,988 # 6a60 <malloc+0xa04>
    168c:	00005097          	auipc	ra,0x5
    1690:	918080e7          	jalr	-1768(ra) # 5fa4 <printf>
        exit(1);
    1694:	4505                	li	a0,1
    ...
    16ae:	b46a0a13          	add	s4,s4,-1210 # 61f0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16b2:	00005a97          	auipc	s5,0x5
    16b6:	3cea8a93          	add	s5,s5,974 # 6a80 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1700:	af450513          	add	a0,a0,-1292 # 61f0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    171e:	31e50513          	add	a0,a0,798 # 6a38 <malloc+0x9dc>
    1722:	00005097          	auipc	ra,0x5
    1726:	882080e7          	jalr	-1918(ra) # 5fa4 <printf>
      exit(1);
    172a:	4505                	li	a0,1
    ...
    173c:	35050513          	add	a0,a0,848 # 6a88 <malloc+0xa2c>
    1740:	00005097          	auipc	ra,0x5
    1744:	864080e7          	jalr	-1948(ra) # 5fa4 <printf>
      exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1762:	a3a78793          	add	a5,a5,-1478 # 6198 <malloc+0x13c>
    1766:	fcf43023          	sd	a5,-64(s0)
    176a:	00005797          	auipc	a5,0x5
    176e:	33e78793          	add	a5,a5,830 # 6aa8 <malloc+0xa4c>
    1772:	fcf43423          	sd	a5,-56(s0)
    1776:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    177a:	00005517          	auipc	a0,0x5
    177e:	33650513          	add	a0,a0,822 # 6ab0 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    17ae:	30650513          	add	a0,a0,774 # 6ab0 <malloc+0xa54>
    ...
    17ca:	30a50513          	add	a0,a0,778 # 6ad0 <malloc+0xa74>
    17ce:	00004097          	auipc	ra,0x4
    17d2:	7d6080e7          	jalr	2006(ra) # 5fa4 <printf>
      exit(1);
    17d6:	4505                	li	a0,1
    ...
    17e8:	23c50513          	add	a0,a0,572 # 6a20 <malloc+0x9c4>
    17ec:	00004097          	auipc	ra,0x4
    17f0:	7b8080e7          	jalr	1976(ra) # 5fa4 <printf>
     exit(1);
    17f4:	4505                	li	a0,1
    ...
    1804:	2b850513          	add	a0,a0,696 # 6ab8 <malloc+0xa5c>
    1808:	00004097          	auipc	ra,0x4
    180c:	79c080e7          	jalr	1948(ra) # 5fa4 <printf>
      exit(1);
    1810:	4505                	li	a0,1
    ...
    1822:	97a50513          	add	a0,a0,-1670 # 6198 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1856:	28e50513          	add	a0,a0,654 # 6ae0 <malloc+0xa84>
    185a:	00004097          	auipc	ra,0x4
    185e:	74a080e7          	jalr	1866(ra) # 5fa4 <printf>
      exit(1);
    1862:	4505                	li	a0,1
    ...
    1872:	28a50513          	add	a0,a0,650 # 6af8 <malloc+0xa9c>
    1876:	00004097          	auipc	ra,0x4
    187a:	72e080e7          	jalr	1838(ra) # 5fa4 <printf>
    187e:	b7d1                	j	1842 <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    1880:	4581                	li	a1,0
    1882:	00005517          	auipc	a0,0x5
    1886:	22e50513          	add	a0,a0,558 # 6ab0 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18b0:	cbc50513          	add	a0,a0,-836 # 6568 <malloc+0x50c>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	6f0080e7          	jalr	1776(ra) # 5fa4 <printf>
    exit(1);
    18bc:	4505                	li	a0,1
    ...
    18cc:	17050513          	add	a0,a0,368 # 6a38 <malloc+0x9dc>
    18d0:	00004097          	auipc	ra,0x4
    18d4:	6d4080e7          	jalr	1748(ra) # 5fa4 <printf>
    exit(1);
    18d8:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18e6:	1ce50513          	add	a0,a0,462 # 6ab0 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1910:	20450513          	add	a0,a0,516 # 6b10 <malloc+0xab4>
    1914:	00004097          	auipc	ra,0x4
    1918:	690080e7          	jalr	1680(ra) # 5fa4 <printf>
    exit(1);
    191c:	4505                	li	a0,1
...
0000000000001930 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1978:	6a4a8a93          	add	s5,s5,1700 # e018 <buf>
    197c:	864a                	mv	a2,s2
    197e:	85d6                	mv	a1,s5
    ...
    1994:	68870713          	add	a4,a4,1672 # e018 <buf>
    ...
    19d8:	15450513          	add	a0,a0,340 # 6b28 <malloc+0xacc>
    19dc:	00004097          	auipc	ra,0x4
    19e0:	5c8080e7          	jalr	1480(ra) # 5fa4 <printf>
    exit(1);
    19e4:	4505                	li	a0,1
    ...
    1a06:	616b0b13          	add	s6,s6,1558 # e018 <buf>
    ...
    1a1a:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a66:	0de50513          	add	a0,a0,222 # 6b40 <malloc+0xae4>
    1a6a:	00004097          	auipc	ra,0x4
    1a6e:	53a080e7          	jalr	1338(ra) # 5fa4 <printf>
        exit(1);
    1a72:	4505                	li	a0,1
    ...
    1a82:	0da50513          	add	a0,a0,218 # 6b58 <malloc+0xafc>
    1a86:	00004097          	auipc	ra,0x4
    1a8a:	51e080e7          	jalr	1310(ra) # 5fa4 <printf>
          return;
    ...
    1ab4:	0c050513          	add	a0,a0,192 # 6b70 <malloc+0xb14>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	4ec080e7          	jalr	1260(ra) # 5fa4 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1b00:	09450513          	add	a0,a0,148 # 6b90 <malloc+0xb34>
    1b04:	00004097          	auipc	ra,0x4
    1b08:	4a0080e7          	jalr	1184(ra) # 5fa4 <printf>
    exit(1);
    1b0c:	4505                	li	a0,1
...
0000000000001b16 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b72:	eb250513          	add	a0,a0,-334 # 6a20 <malloc+0x9c4>
    1b76:	00004097          	auipc	ra,0x4
    1b7a:	42e080e7          	jalr	1070(ra) # 5fa4 <printf>
      exit(1);
    1b7e:	4505                	li	a0,1
    ...
    1b8e:	01e50513          	add	a0,a0,30 # 6ba8 <malloc+0xb4c>
    1b92:	00004097          	auipc	ra,0x4
    1b96:	412080e7          	jalr	1042(ra) # 5fa4 <printf>
        exit(1);
    1b9a:	4505                	li	a0,1
    ...
    1baa:	01a50513          	add	a0,a0,26 # 6bc0 <malloc+0xb64>
    1bae:	00004097          	auipc	ra,0x4
    1bb2:	3f6080e7          	jalr	1014(ra) # 5fa4 <printf>
        exit(1);
    1bb6:	4505                	li	a0,1
...
0000000000001bca <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c22:	e0250513          	add	a0,a0,-510 # 6a20 <malloc+0x9c4>
    1c26:	00004097          	auipc	ra,0x4
    1c2a:	37e080e7          	jalr	894(ra) # 5fa4 <printf>
      exit(1);
    1c2e:	4505                	li	a0,1
    ...
    1c46:	dde50513          	add	a0,a0,-546 # 6a20 <malloc+0x9c4>
    1c4a:	00004097          	auipc	ra,0x4
    1c4e:	35a080e7          	jalr	858(ra) # 5fa4 <printf>
        exit(1);
    1c52:	4505                	li	a0,1
...
0000000000001c64 <forkfork>:
{
    ...
    1cc0:	f2450513          	add	a0,a0,-220 # 6be0 <malloc+0xb84>
    1cc4:	00004097          	auipc	ra,0x4
    1cc8:	2e0080e7          	jalr	736(ra) # 5fa4 <printf>
      exit(1);
    1ccc:	4505                	li	a0,1
    ...
    1cd2:	f5e080e7          	jalr	-162(ra) # 5c2c <exit>
{
    ...
    1d18:	edc50513          	add	a0,a0,-292 # 6bf0 <malloc+0xb94>
    1d1c:	00004097          	auipc	ra,0x4
    1d20:	288080e7          	jalr	648(ra) # 5fa4 <printf>
      exit(1);
    1d24:	4505                	li	a0,1
...
0000000000001d2e <reparent2>:
{
  ...
  exit(0);
    ...
    1d66:	0c650513          	add	a0,a0,198 # 6e28 <malloc+0xdcc>
    1d6a:	00004097          	auipc	ra,0x4
    1d6e:	23a080e7          	jalr	570(ra) # 5fa4 <printf>
      exit(1);
    1d72:	4505                	li	a0,1
...
0000000000001d96 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e04:	02850513          	add	a0,a0,40 # 6e28 <malloc+0xdcc>
    1e08:	00004097          	auipc	ra,0x4
    1e0c:	19c080e7          	jalr	412(ra) # 5fa4 <printf>
      exit(1);
    1e10:	4505                	li	a0,1
    ...
    1e30:	c8c50513          	add	a0,a0,-884 # 6ab8 <malloc+0xa5c>
    1e34:	00004097          	auipc	ra,0x4
    1e38:	170080e7          	jalr	368(ra) # 5fa4 <printf>
          exit(1);
    1e3c:	4505                	li	a0,1
    ...
    1ea2:	d7250513          	add	a0,a0,-654 # 6c10 <malloc+0xbb4>
    1ea6:	00004097          	auipc	ra,0x4
    1eaa:	0fe080e7          	jalr	254(ra) # 5fa4 <printf>
            exit(1);
    1eae:	4505                	li	a0,1
    ...
    1ed6:	d5650513          	add	a0,a0,-682 # 6c28 <malloc+0xbcc>
    1eda:	00004097          	auipc	ra,0x4
    1ede:	0ca080e7          	jalr	202(ra) # 5fa4 <printf>
        exit(1);
    1ee2:	4505                	li	a0,1
    ...
    1f38:	d1c50513          	add	a0,a0,-740 # 6c50 <malloc+0xbf4>
    1f3c:	00004097          	auipc	ra,0x4
    1f40:	068080e7          	jalr	104(ra) # 5fa4 <printf>
        exit(1);
    1f44:	4505                	li	a0,1
...
0000000000001fbc <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fdc:	23050513          	add	a0,a0,560 # 6208 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2006:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <base+0x41c53e55>
    ...
    2018:	1f4b0b13          	add	s6,s6,500 # 6208 <malloc+0x1ac>
      link("cat", "x");
    201c:	00005c17          	auipc	s8,0x5
    2020:	c5cc0c13          	add	s8,s8,-932 # 6c78 <malloc+0xc1c>
    2024:	a825                	j	205c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2026:	85a6                	mv	a1,s1
    2028:	00005517          	auipc	a0,0x5
    202c:	9f850513          	add	a0,a0,-1544 # 6a20 <malloc+0x9c4>
    2030:	00004097          	auipc	ra,0x4
    2034:	f74080e7          	jalr	-140(ra) # 5fa4 <printf>
    exit(1);
    2038:	4505                	li	a0,1
...
00000000000020c0 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20f0:	bdc50513          	add	a0,a0,-1060 # 6cc8 <malloc+0xc6c>
    20f4:	00004097          	auipc	ra,0x4
    20f8:	eb0080e7          	jalr	-336(ra) # 5fa4 <printf>
    exit(1);
    20fc:	4505                	li	a0,1
    ...
    2114:	b7050513          	add	a0,a0,-1168 # 6c80 <malloc+0xc24>
    2118:	00004097          	auipc	ra,0x4
    211c:	e8c080e7          	jalr	-372(ra) # 5fa4 <printf>
    exit(1);
    2120:	4505                	li	a0,1
    ...
    2130:	b6c50513          	add	a0,a0,-1172 # 6c98 <malloc+0xc3c>
    2134:	00004097          	auipc	ra,0x4
    2138:	e70080e7          	jalr	-400(ra) # 5fa4 <printf>
      exit(1);
    213c:	4505                	li	a0,1
    ...
    214c:	b6850513          	add	a0,a0,-1176 # 6cb0 <malloc+0xc54>
    2150:	00004097          	auipc	ra,0x4
    2154:	e54080e7          	jalr	-428(ra) # 5fa4 <printf>
    exit(1);
    2158:	4505                	li	a0,1
...
0000000000002198 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21b4:	35098993          	add	s3,s3,848 # c350 <uninit+0xa48>
    21b8:	1003d937          	lui	s2,0x1003d
    21bc:	090e                	sll	s2,s2,0x3
    21be:	48090913          	add	s2,s2,1152 # 1003d480 <base+0x1002c468>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2202:	82250513          	add	a0,a0,-2014 # 6a20 <malloc+0x9c4>
    2206:	00004097          	auipc	ra,0x4
    220a:	d9e080e7          	jalr	-610(ra) # 5fa4 <printf>
      exit(1);
    220e:	4505                	li	a0,1
    ...
    2224:	ad050513          	add	a0,a0,-1328 # 6cf0 <malloc+0xc94>
    2228:	00004097          	auipc	ra,0x4
    222c:	d7c080e7          	jalr	-644(ra) # 5fa4 <printf>
      exit(1);
    2230:	4505                	li	a0,1
...
0000000000002244 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a6:	77e50513          	add	a0,a0,1918 # 6a20 <malloc+0x9c4>
    22aa:	00004097          	auipc	ra,0x4
    22ae:	cfa080e7          	jalr	-774(ra) # 5fa4 <printf>
      exit(1);
    22b2:	4505                	li	a0,1
    ...
    22d2:	a4250513          	add	a0,a0,-1470 # 6d10 <malloc+0xcb4>
    22d6:	00004097          	auipc	ra,0x4
    22da:	cce080e7          	jalr	-818(ra) # 5fa4 <printf>
      exit(1);
    22de:	4505                	li	a0,1
...
00000000000022f2 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2302:	a2a50513          	add	a0,a0,-1494 # 6d28 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2334:	9f850513          	add	a0,a0,-1544 # 6d28 <malloc+0xccc>
  ...
  close(fd);
    ...
    235a:	4aa78793          	add	a5,a5,1194 # a800 <args.1>
    235e:	00008697          	auipc	a3,0x8
    2362:	59a68693          	add	a3,a3,1434 # a8f8 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    2366:	00005717          	auipc	a4,0x5
    236a:	9d270713          	add	a4,a4,-1582 # 6d38 <malloc+0xcdc>
    ...
    23be:	a5e50513          	add	a0,a0,-1442 # 6e18 <malloc+0xdbc>
    23c2:	00004097          	auipc	ra,0x4
    23c6:	be2080e7          	jalr	-1054(ra) # 5fa4 <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23e2:	a5a50513          	add	a0,a0,-1446 # 6e38 <malloc+0xddc>
    23e6:	00004097          	auipc	ra,0x4
    23ea:	bbe080e7          	jalr	-1090(ra) # 5fa4 <printf>
    exit(1);
    23ee:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2436:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <base+0xfffffffffffedfe8>
    243a:	85a6                	mv	a1,s1
    243c:	00005517          	auipc	a0,0x5
    2440:	a1c50513          	add	a0,a0,-1508 # 6e58 <malloc+0xdfc>
    2444:	00004097          	auipc	ra,0x4
    2448:	b60080e7          	jalr	-1184(ra) # 5fa4 <printf>
    exit(1);
    244c:	4505                	li	a0,1
    ...
    245c:	5c850513          	add	a0,a0,1480 # 6a20 <malloc+0x9c4>
    2460:	00004097          	auipc	ra,0x4
    2464:	b44080e7          	jalr	-1212(ra) # 5fa4 <printf>
    exit(1);
    2468:	4505                	li	a0,1
...
000000000000247c <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24ca:	55a50513          	add	a0,a0,1370 # 6a20 <malloc+0x9c4>
    24ce:	00004097          	auipc	ra,0x4
    24d2:	ad6080e7          	jalr	-1322(ra) # 5fa4 <printf>
    exit(1);
    24d6:	4505                	li	a0,1
...
00000000000024ea <manywrites>:
{
  ...
  exit(0);
    ...
    254e:	8de50513          	add	a0,a0,-1826 # 6e28 <malloc+0xdcc>
    2552:	00004097          	auipc	ra,0x4
    2556:	a52080e7          	jalr	-1454(ra) # 5fa4 <printf>
      exit(1);
    255a:	4505                	li	a0,1
    ...
    2590:	a8cb0b13          	add	s6,s6,-1396 # e018 <buf>
    ...
    2604:	88050513          	add	a0,a0,-1920 # 6e80 <malloc+0xe24>
    2608:	00004097          	auipc	ra,0x4
    260c:	99c080e7          	jalr	-1636(ra) # 5fa4 <printf>
            exit(1);
    2610:	4505                	li	a0,1
    ...
    2624:	c4850513          	add	a0,a0,-952 # 6268 <malloc+0x20c>
    2628:	00004097          	auipc	ra,0x4
    262c:	97c080e7          	jalr	-1668(ra) # 5fa4 <printf>
            exit(1);
    2630:	4505                	li	a0,1
...
0000000000002642 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26bc:	4c078793          	add	a5,a5,1216 # 7b78 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26fe:	79e50513          	add	a0,a0,1950 # 6e98 <malloc+0xe3c>
    2702:	00004097          	auipc	ra,0x4
    2706:	8a2080e7          	jalr	-1886(ra) # 5fa4 <printf>
    exit(1);
    270a:	4505                	li	a0,1
    ...
    271c:	22850513          	add	a0,a0,552 # 6940 <malloc+0x8e4>
    2720:	00004097          	auipc	ra,0x4
    2724:	884080e7          	jalr	-1916(ra) # 5fa4 <printf>
    exit(1);
    2728:	4505                	li	a0,1
    ...
    273a:	22a50513          	add	a0,a0,554 # 6960 <malloc+0x904>
    273e:	00004097          	auipc	ra,0x4
    2742:	866080e7          	jalr	-1946(ra) # 5fa4 <printf>
    exit(1);
    2746:	4505                	li	a0,1
    ...
    275a:	22a50513          	add	a0,a0,554 # 6980 <malloc+0x924>
    275e:	00004097          	auipc	ra,0x4
    2762:	846080e7          	jalr	-1978(ra) # 5fa4 <printf>
    exit(1);
    2766:	4505                	li	a0,1
    ...
    2778:	23450513          	add	a0,a0,564 # 69a8 <malloc+0x94c>
    277c:	00004097          	auipc	ra,0x4
    2780:	828080e7          	jalr	-2008(ra) # 5fa4 <printf>
    exit(1);
    2784:	4505                	li	a0,1
...
000000000000278e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c4:	71850513          	add	a0,a0,1816 # 6ed8 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27f4:	70850513          	add	a0,a0,1800 # 6ef8 <malloc+0xe9c>
    27f8:	00003097          	auipc	ra,0x3
    27fc:	7ac080e7          	jalr	1964(ra) # 5fa4 <printf>
    exit(1);
    2800:	4505                	li	a0,1
    ...
    2812:	69250513          	add	a0,a0,1682 # 6ea0 <malloc+0xe44>
    2816:	00003097          	auipc	ra,0x3
    281a:	78e080e7          	jalr	1934(ra) # 5fa4 <printf>
    exit(1);
    281e:	4505                	li	a0,1
    ...
    282e:	68e50513          	add	a0,a0,1678 # 6eb8 <malloc+0xe5c>
    2832:	00003097          	auipc	ra,0x3
    2836:	772080e7          	jalr	1906(ra) # 5fa4 <printf>
    exit(1);
    283a:	4505                	li	a0,1
    ...
    2848:	69c50513          	add	a0,a0,1692 # 6ee0 <malloc+0xe84>
    284c:	00003097          	auipc	ra,0x3
    2850:	758080e7          	jalr	1880(ra) # 5fa4 <printf>
    exit(1);
    2854:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    28a8:	68450513          	add	a0,a0,1668 # 6f28 <malloc+0xecc>
    28ac:	00003097          	auipc	ra,0x3
    28b0:	6f8080e7          	jalr	1784(ra) # 5fa4 <printf>
    exit(1);
    28b4:	4505                	li	a0,1
    ...
    28c2:	62250513          	add	a0,a0,1570 # 6ee0 <malloc+0xe84>
    28c6:	00003097          	auipc	ra,0x3
    28ca:	6de080e7          	jalr	1758(ra) # 5fa4 <printf>
    exit(1);
    28ce:	4505                	li	a0,1
...
00000000000028ec <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2928:	6705                	lui	a4,0x1
      *b = 99;
    292a:	00d50023          	sb	a3,0(a0) # 40000000 <base+0x3ffeefe8>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2948:	60c50513          	add	a0,a0,1548 # 6f50 <malloc+0xef4>
    294c:	00003097          	auipc	ra,0x3
    2950:	658080e7          	jalr	1624(ra) # 5fa4 <printf>
    exit(1);
    2954:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    29ac:	5c850513          	add	a0,a0,1480 # 6f70 <malloc+0xf14>
    29b0:	00003097          	auipc	ra,0x3
    29b4:	5f4080e7          	jalr	1524(ra) # 5fa4 <printf>
    exit(1);
    29b8:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2a10:	5c450513          	add	a0,a0,1476 # 6fd0 <malloc+0xf74>
    2a14:	00003097          	auipc	ra,0x3
    2a18:	590080e7          	jalr	1424(ra) # 5fa4 <printf>
    exit(1);
    2a1c:	4505                	li	a0,1
    ...
    2a32:	56250513          	add	a0,a0,1378 # 6f90 <malloc+0xf34>
    2a36:	00003097          	auipc	ra,0x3
    2a3a:	56e080e7          	jalr	1390(ra) # 5fa4 <printf>
      exit(1);
    2a3e:	4505                	li	a0,1
    ...
    2a4e:	56650513          	add	a0,a0,1382 # 6fb0 <malloc+0xf54>
    2a52:	00003097          	auipc	ra,0x3
    2a56:	552080e7          	jalr	1362(ra) # 5fa4 <printf>
    exit(1);
    2a5a:	4505                	li	a0,1
...
0000000000002a8a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2aec:	fee78fa3          	sb	a4,-1(a5) # 63fffff <base+0x63eefe7>
  a = sbrk(0);
    2af0:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2b50:	fff7c703          	lbu	a4,-1(a5) # 63fffff <base+0x63eefe7>
  ...
  if(c != a){
    ...
    2b98:	45c50513          	add	a0,a0,1116 # 6ff0 <malloc+0xf94>
    2b9c:	00003097          	auipc	ra,0x3
    2ba0:	408080e7          	jalr	1032(ra) # 5fa4 <printf>
    exit(1);
    2ba4:	4505                	li	a0,1
    ...
    2bb4:	48850513          	add	a0,a0,1160 # 7038 <malloc+0xfdc>
    2bb8:	00003097          	auipc	ra,0x3
    2bbc:	3ec080e7          	jalr	1004(ra) # 5fa4 <printf>
    exit(1);
    2bc0:	4505                	li	a0,1
    ...
    2bd4:	48850513          	add	a0,a0,1160 # 7058 <malloc+0xffc>
    2bd8:	00003097          	auipc	ra,0x3
    2bdc:	3cc080e7          	jalr	972(ra) # 5fa4 <printf>
    exit(1);
    2be0:	4505                	li	a0,1
    ...
    2bf4:	4a850513          	add	a0,a0,1192 # 7098 <malloc+0x103c>
    2bf8:	00003097          	auipc	ra,0x3
    2bfc:	3ac080e7          	jalr	940(ra) # 5fa4 <printf>
    exit(1);
    2c00:	4505                	li	a0,1
    ...
    2c10:	4bc50513          	add	a0,a0,1212 # 70c8 <malloc+0x106c>
    2c14:	00003097          	auipc	ra,0x3
    2c18:	390080e7          	jalr	912(ra) # 5fa4 <printf>
    exit(1);
    2c1c:	4505                	li	a0,1
    ...
    2c30:	4d450513          	add	a0,a0,1236 # 7100 <malloc+0x10a4>
    2c34:	00003097          	auipc	ra,0x3
    2c38:	370080e7          	jalr	880(ra) # 5fa4 <printf>
    exit(1);
    2c3c:	4505                	li	a0,1
...
0000000000002c46 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c6a:	4c250513          	add	a0,a0,1218 # 7128 <malloc+0x10cc>
    2c6e:	00003097          	auipc	ra,0x3
    2c72:	ffe080e7          	jalr	-2(ra) # 5c6c <open>
    2c76:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c78:	00004517          	auipc	a0,0x4
    2c7c:	4b050513          	add	a0,a0,1200 # 7128 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cd0:	46450513          	add	a0,a0,1124 # 7130 <malloc+0x10d4>
    2cd4:	00003097          	auipc	ra,0x3
    2cd8:	2d0080e7          	jalr	720(ra) # 5fa4 <printf>
    exit(1);
    2cdc:	4505                	li	a0,1
    ...
    2cec:	46050513          	add	a0,a0,1120 # 7148 <malloc+0x10ec>
    2cf0:	00003097          	auipc	ra,0x3
    2cf4:	2b4080e7          	jalr	692(ra) # 5fa4 <printf>
    exit(1);
    2cf8:	4505                	li	a0,1
    ...
    2d08:	e2450513          	add	a0,a0,-476 # 6b28 <malloc+0xacc>
    2d0c:	00003097          	auipc	ra,0x3
    2d10:	298080e7          	jalr	664(ra) # 5fa4 <printf>
    exit(1);
    2d14:	4505                	li	a0,1
...
0000000000002d1e <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d32:	43250513          	add	a0,a0,1074 # 7160 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d7a:	cc250513          	add	a0,a0,-830 # 6a38 <malloc+0x9dc>
    2d7e:	00003097          	auipc	ra,0x3
    2d82:	226080e7          	jalr	550(ra) # 5fa4 <printf>
    exit(1);
    2d86:	4505                	li	a0,1
...
0000000000002d90 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc8:	06450513          	add	a0,a0,100 # 6e28 <malloc+0xdcc>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	1d8080e7          	jalr	472(ra) # 5fa4 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e1e:	00e50513          	add	a0,a0,14 # 6e28 <malloc+0xdcc>
    2e22:	00003097          	auipc	ra,0x3
    2e26:	182080e7          	jalr	386(ra) # 5fa4 <printf>
    exit(1);
    2e2a:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e56:	8007879b          	addw	a5,a5,-2048 # a800 <args.1>
    ...
    2e7e:	fae50513          	add	a0,a0,-82 # 6e28 <malloc+0xdcc>
    2e82:	00003097          	auipc	ra,0x3
    2e86:	122080e7          	jalr	290(ra) # 5fa4 <printf>
    exit(1);
    2e8a:	4505                	li	a0,1
...
0000000000002f7a <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f86:	0511                	add	a0,a0,4 # ffffffff80000004 <base+0xffffffff7ffeefec>
...
0000000000002fb0 <execout>:
{
  ...
  exit(0);
    ...
    2ff2:	e3a50513          	add	a0,a0,-454 # 6e28 <malloc+0xdcc>
    2ff6:	00003097          	auipc	ra,0x3
    2ffa:	fae080e7          	jalr	-82(ra) # 5fa4 <printf>
      exit(1);
    2ffe:	4505                	li	a0,1
    ...
    3046:	15650513          	add	a0,a0,342 # 6198 <malloc+0x13c>
    304a:	faa43c23          	sd	a0,-72(s0)
    304e:	00003797          	auipc	a5,0x3
    3052:	1ba78793          	add	a5,a5,442 # 6208 <malloc+0x1ac>
...
0000000000003074 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3084:	2b850513          	add	a0,a0,696 # 7338 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3096:	0fe50513          	add	a0,a0,254 # 7190 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30ac:	14050513          	add	a0,a0,320 # 71e8 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30ca:	19a50513          	add	a0,a0,410 # 7260 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e6:	1ee50513          	add	a0,a0,494 # 72d0 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f8:	23450513          	add	a0,a0,564 # 7328 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3176:	ff650513          	add	a0,a0,-10 # 7168 <malloc+0x110c>
    317a:	00003097          	auipc	ra,0x3
    317e:	e2a080e7          	jalr	-470(ra) # 5fa4 <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    3192:	02250513          	add	a0,a0,34 # 71b0 <malloc+0x1154>
    3196:	00003097          	auipc	ra,0x3
    319a:	e0e080e7          	jalr	-498(ra) # 5fa4 <printf>
    exit(1);
    319e:	4505                	li	a0,1
    ...
    31ae:	06e50513          	add	a0,a0,110 # 7218 <malloc+0x11bc>
    31b2:	00003097          	auipc	ra,0x3
    31b6:	df2080e7          	jalr	-526(ra) # 5fa4 <printf>
    exit(1);
    31ba:	4505                	li	a0,1
    ...
    31ca:	0ca50513          	add	a0,a0,202 # 7290 <malloc+0x1234>
    31ce:	00003097          	auipc	ra,0x3
    31d2:	dd6080e7          	jalr	-554(ra) # 5fa4 <printf>
    exit(1);
    31d6:	4505                	li	a0,1
    ...
    31e6:	10e50513          	add	a0,a0,270 # 72f0 <malloc+0x1294>
    31ea:	00003097          	auipc	ra,0x3
    31ee:	dba080e7          	jalr	-582(ra) # 5fa4 <printf>
    exit(1);
    31f2:	4505                	li	a0,1
    ...
    3202:	14a50513          	add	a0,a0,330 # 7348 <malloc+0x12ec>
    3206:	00003097          	auipc	ra,0x3
    320a:	d9e080e7          	jalr	-610(ra) # 5fa4 <printf>
    exit(1);
    320e:	4505                	li	a0,1
...
0000000000003218 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3252:	13250513          	add	a0,a0,306 # 7380 <malloc+0x1324>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    3282:	11250513          	add	a0,a0,274 # 7390 <malloc+0x1334>
    3286:	00003097          	auipc	ra,0x3
    328a:	d1e080e7          	jalr	-738(ra) # 5fa4 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3310:	07450513          	add	a0,a0,116 # 7380 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    3324:	06050513          	add	a0,a0,96 # 7380 <malloc+0x1324>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    345c:	f5850513          	add	a0,a0,-168 # 73b0 <malloc+0x1354>
    3460:	00003097          	auipc	ra,0x3
    3464:	b44080e7          	jalr	-1212(ra) # 5fa4 <printf>
...
000000000000346a <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    347a:	f6a50513          	add	a0,a0,-150 # 73e0 <malloc+0x1384>
  ...
  if(chdir("iputdir") < 0){
    ...
    348e:	f5650513          	add	a0,a0,-170 # 73e0 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    34a2:	f8250513          	add	a0,a0,-126 # 7420 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    34b6:	f9e50513          	add	a0,a0,-98 # 7450 <malloc+0x13f4>
    ...
    34d6:	f1650513          	add	a0,a0,-234 # 73e8 <malloc+0x138c>
    34da:	00003097          	auipc	ra,0x3
    34de:	aca080e7          	jalr	-1334(ra) # 5fa4 <printf>
    exit(1);
    34e2:	4505                	li	a0,1
    ...
    34f2:	f1250513          	add	a0,a0,-238 # 7400 <malloc+0x13a4>
    34f6:	00003097          	auipc	ra,0x3
    34fa:	aae080e7          	jalr	-1362(ra) # 5fa4 <printf>
    exit(1);
    34fe:	4505                	li	a0,1
    ...
    350e:	f2650513          	add	a0,a0,-218 # 7430 <malloc+0x13d4>
    3512:	00003097          	auipc	ra,0x3
    3516:	a92080e7          	jalr	-1390(ra) # 5fa4 <printf>
    exit(1);
    351a:	4505                	li	a0,1
    ...
    352a:	f3250513          	add	a0,a0,-206 # 7458 <malloc+0x13fc>
    352e:	00003097          	auipc	ra,0x3
    3532:	a76080e7          	jalr	-1418(ra) # 5fa4 <printf>
    exit(1);
    3536:	4505                	li	a0,1
...
0000000000003540 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    355e:	e8650513          	add	a0,a0,-378 # 73e0 <malloc+0x1384>
    ...
    3572:	e7250513          	add	a0,a0,-398 # 73e0 <malloc+0x1384>
    ...
    3586:	e9e50513          	add	a0,a0,-354 # 7420 <malloc+0x13c4>
    ...
    35a6:	47e50513          	add	a0,a0,1150 # 6a20 <malloc+0x9c4>
    35aa:	00003097          	auipc	ra,0x3
    35ae:	9fa080e7          	jalr	-1542(ra) # 5fa4 <printf>
    exit(1);
    35b2:	4505                	li	a0,1
    ...
    35c2:	e2a50513          	add	a0,a0,-470 # 73e8 <malloc+0x138c>
    35c6:	00003097          	auipc	ra,0x3
    35ca:	9de080e7          	jalr	-1570(ra) # 5fa4 <printf>
      exit(1);
    35ce:	4505                	li	a0,1
    ...
    35de:	e9650513          	add	a0,a0,-362 # 7470 <malloc+0x1414>
    35e2:	00003097          	auipc	ra,0x3
    35e6:	9c2080e7          	jalr	-1598(ra) # 5fa4 <printf>
      exit(1);
    35ea:	4505                	li	a0,1
    ...
    35fa:	e3a50513          	add	a0,a0,-454 # 7430 <malloc+0x13d4>
    35fe:	00003097          	auipc	ra,0x3
    3602:	9a6080e7          	jalr	-1626(ra) # 5fa4 <printf>
      exit(1);
    3606:	4505                	li	a0,1
...
0000000000003628 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3638:	e5450513          	add	a0,a0,-428 # 7488 <malloc+0x142c>
  ...
  if(chdir("dir0") < 0){
    ...
    364c:	e4050513          	add	a0,a0,-448 # 7488 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    3660:	e4c50513          	add	a0,a0,-436 # 74a8 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3674:	e1850513          	add	a0,a0,-488 # 7488 <malloc+0x142c>
    ...
    3694:	d5850513          	add	a0,a0,-680 # 73e8 <malloc+0x138c>
    3698:	00003097          	auipc	ra,0x3
    369c:	90c080e7          	jalr	-1780(ra) # 5fa4 <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	de450513          	add	a0,a0,-540 # 7490 <malloc+0x1434>
    36b4:	00003097          	auipc	ra,0x3
    36b8:	8f0080e7          	jalr	-1808(ra) # 5fa4 <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	de850513          	add	a0,a0,-536 # 74b0 <malloc+0x1454>
    36d0:	00003097          	auipc	ra,0x3
    36d4:	8d4080e7          	jalr	-1836(ra) # 5fa4 <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	de450513          	add	a0,a0,-540 # 74c8 <malloc+0x146c>
    36ec:	00003097          	auipc	ra,0x3
    36f0:	8b8080e7          	jalr	-1864(ra) # 5fa4 <printf>
    exit(1);
    36f4:	4505                	li	a0,1
...
00000000000036fe <subdir>:
{
  ...
  unlink("ff");
    ...
    3710:	f0450513          	add	a0,a0,-252 # 7610 <malloc+0x15b4>
    3714:	00002097          	auipc	ra,0x2
    3718:	568080e7          	jalr	1384(ra) # 5c7c <unlink>
  if(mkdir("dd") != 0){
    371c:	00004517          	auipc	a0,0x4
    3720:	dc450513          	add	a0,a0,-572 # 74e0 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3738:	dcc50513          	add	a0,a0,-564 # 7500 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    3750:	ec458593          	add	a1,a1,-316 # 7610 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    376a:	d7a50513          	add	a0,a0,-646 # 74e0 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    377e:	dde50513          	add	a0,a0,-546 # 7558 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3796:	dee50513          	add	a0,a0,-530 # 7580 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    37ae:	e0658593          	add	a1,a1,-506 # 75b0 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37ca:	df250513          	add	a0,a0,-526 # 75b8 <malloc+0x155c>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    37e2:	83a58593          	add	a1,a1,-1990 # e018 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    37f8:	82474703          	lbu	a4,-2012(a4) # e018 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3812:	dfa58593          	add	a1,a1,-518 # 7608 <malloc+0x15ac>
    3816:	00004517          	auipc	a0,0x4
    381a:	d6a50513          	add	a0,a0,-662 # 7580 <malloc+0x1524>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    382e:	d5650513          	add	a0,a0,-682 # 7580 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3844:	d4050513          	add	a0,a0,-704 # 7580 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    3858:	c8c50513          	add	a0,a0,-884 # 74e0 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    386c:	e3850513          	add	a0,a0,-456 # 76a0 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3880:	e5450513          	add	a0,a0,-428 # 76d0 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3894:	e7050513          	add	a0,a0,-400 # 7700 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    38aa:	d6250513          	add	a0,a0,-670 # 7608 <malloc+0x15ac>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    38c2:	75a58593          	add	a1,a1,1882 # e018 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38e4:	ca050513          	add	a0,a0,-864 # 7580 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38fc:	e9850513          	add	a0,a0,-360 # 7790 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3914:	eb050513          	add	a0,a0,-336 # 77c0 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    392c:	bb850513          	add	a0,a0,-1096 # 74e0 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3942:	ba250513          	add	a0,a0,-1118 # 74e0 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3958:	b8c50513          	add	a0,a0,-1140 # 74e0 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    396c:	ee858593          	add	a1,a1,-280 # 7850 <malloc+0x17f4>
    3970:	00004517          	auipc	a0,0x4
    3974:	e2050513          	add	a0,a0,-480 # 7790 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3988:	ecc58593          	add	a1,a1,-308 # 7850 <malloc+0x17f4>
    398c:	00004517          	auipc	a0,0x4
    3990:	e3450513          	add	a0,a0,-460 # 77c0 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    39a4:	c6858593          	add	a1,a1,-920 # 7608 <malloc+0x15ac>
    39a8:	00004517          	auipc	a0,0x4
    39ac:	b5850513          	add	a0,a0,-1192 # 7500 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39c0:	dd450513          	add	a0,a0,-556 # 7790 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39d4:	df050513          	add	a0,a0,-528 # 77c0 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39e8:	c2450513          	add	a0,a0,-988 # 7608 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39fc:	dc850513          	add	a0,a0,-568 # 77c0 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3a10:	d8450513          	add	a0,a0,-636 # 7790 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a24:	ae050513          	add	a0,a0,-1312 # 7500 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a38:	f6c50513          	add	a0,a0,-148 # 79a0 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a4c:	bc050513          	add	a0,a0,-1088 # 7608 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a60:	aa450513          	add	a0,a0,-1372 # 7500 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a74:	a7050513          	add	a0,a0,-1424 # 74e0 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a88:	f8c50513          	add	a0,a0,-116 # 7a10 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a9c:	a4850513          	add	a0,a0,-1464 # 74e0 <malloc+0x1484>
    ...
    3abe:	a2e50513          	add	a0,a0,-1490 # 74e8 <malloc+0x148c>
    3ac2:	00002097          	auipc	ra,0x2
    3ac6:	4e2080e7          	jalr	1250(ra) # 5fa4 <printf>
    exit(1);
    3aca:	4505                	li	a0,1
    ...
    3ada:	a3250513          	add	a0,a0,-1486 # 7508 <malloc+0x14ac>
    3ade:	00002097          	auipc	ra,0x2
    3ae2:	4c6080e7          	jalr	1222(ra) # 5fa4 <printf>
    exit(1);
    3ae6:	4505                	li	a0,1
    ...
    3af6:	a3650513          	add	a0,a0,-1482 # 7528 <malloc+0x14cc>
    3afa:	00002097          	auipc	ra,0x2
    3afe:	4aa080e7          	jalr	1194(ra) # 5fa4 <printf>
    exit(1);
    3b02:	4505                	li	a0,1
    ...
    3b12:	a5250513          	add	a0,a0,-1454 # 7560 <malloc+0x1504>
    3b16:	00002097          	auipc	ra,0x2
    3b1a:	48e080e7          	jalr	1166(ra) # 5fa4 <printf>
    exit(1);
    3b1e:	4505                	li	a0,1
    ...
    3b2e:	a6650513          	add	a0,a0,-1434 # 7590 <malloc+0x1534>
    3b32:	00002097          	auipc	ra,0x2
    3b36:	472080e7          	jalr	1138(ra) # 5fa4 <printf>
    exit(1);
    3b3a:	4505                	li	a0,1
    ...
    3b4a:	a8250513          	add	a0,a0,-1406 # 75c8 <malloc+0x156c>
    3b4e:	00002097          	auipc	ra,0x2
    3b52:	456080e7          	jalr	1110(ra) # 5fa4 <printf>
    exit(1);
    3b56:	4505                	li	a0,1
    ...
    3b66:	a8650513          	add	a0,a0,-1402 # 75e8 <malloc+0x158c>
    3b6a:	00002097          	auipc	ra,0x2
    3b6e:	43a080e7          	jalr	1082(ra) # 5fa4 <printf>
    exit(1);
    3b72:	4505                	li	a0,1
    ...
    3b82:	a9a50513          	add	a0,a0,-1382 # 7618 <malloc+0x15bc>
    3b86:	00002097          	auipc	ra,0x2
    3b8a:	41e080e7          	jalr	1054(ra) # 5fa4 <printf>
    exit(1);
    3b8e:	4505                	li	a0,1
    ...
    3b9e:	aa650513          	add	a0,a0,-1370 # 7640 <malloc+0x15e4>
    3ba2:	00002097          	auipc	ra,0x2
    3ba6:	402080e7          	jalr	1026(ra) # 5fa4 <printf>
    exit(1);
    3baa:	4505                	li	a0,1
    ...
    3bba:	aaa50513          	add	a0,a0,-1366 # 7660 <malloc+0x1604>
    3bbe:	00002097          	auipc	ra,0x2
    3bc2:	3e6080e7          	jalr	998(ra) # 5fa4 <printf>
    exit(1);
    3bc6:	4505                	li	a0,1
    ...
    3bd6:	ab650513          	add	a0,a0,-1354 # 7688 <malloc+0x162c>
    3bda:	00002097          	auipc	ra,0x2
    3bde:	3ca080e7          	jalr	970(ra) # 5fa4 <printf>
    exit(1);
    3be2:	4505                	li	a0,1
    ...
    3bf2:	ac250513          	add	a0,a0,-1342 # 76b0 <malloc+0x1654>
    3bf6:	00002097          	auipc	ra,0x2
    3bfa:	3ae080e7          	jalr	942(ra) # 5fa4 <printf>
    exit(1);
    3bfe:	4505                	li	a0,1
    ...
    3c0e:	ad650513          	add	a0,a0,-1322 # 76e0 <malloc+0x1684>
    3c12:	00002097          	auipc	ra,0x2
    3c16:	392080e7          	jalr	914(ra) # 5fa4 <printf>
    exit(1);
    3c1a:	4505                	li	a0,1
    ...
    3c2a:	ae250513          	add	a0,a0,-1310 # 7708 <malloc+0x16ac>
    3c2e:	00002097          	auipc	ra,0x2
    3c32:	376080e7          	jalr	886(ra) # 5fa4 <printf>
    exit(1);
    3c36:	4505                	li	a0,1
    ...
    3c46:	ade50513          	add	a0,a0,-1314 # 7720 <malloc+0x16c4>
    3c4a:	00002097          	auipc	ra,0x2
    3c4e:	35a080e7          	jalr	858(ra) # 5fa4 <printf>
    exit(1);
    3c52:	4505                	li	a0,1
    ...
    3c62:	ae250513          	add	a0,a0,-1310 # 7740 <malloc+0x16e4>
    3c66:	00002097          	auipc	ra,0x2
    3c6a:	33e080e7          	jalr	830(ra) # 5fa4 <printf>
    exit(1);
    3c6e:	4505                	li	a0,1
    ...
    3c7e:	ae650513          	add	a0,a0,-1306 # 7760 <malloc+0x1704>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	322080e7          	jalr	802(ra) # 5fa4 <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	b0a50513          	add	a0,a0,-1270 # 77a0 <malloc+0x1744>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	306080e7          	jalr	774(ra) # 5fa4 <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	b1e50513          	add	a0,a0,-1250 # 77d0 <malloc+0x1774>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	2ea080e7          	jalr	746(ra) # 5fa4 <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	b2250513          	add	a0,a0,-1246 # 77f0 <malloc+0x1794>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	2ce080e7          	jalr	718(ra) # 5fa4 <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	b2650513          	add	a0,a0,-1242 # 7810 <malloc+0x17b4>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	2b2080e7          	jalr	690(ra) # 5fa4 <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	b2a50513          	add	a0,a0,-1238 # 7830 <malloc+0x17d4>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	296080e7          	jalr	662(ra) # 5fa4 <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	b3e50513          	add	a0,a0,-1218 # 7860 <malloc+0x1804>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	27a080e7          	jalr	634(ra) # 5fa4 <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	b4a50513          	add	a0,a0,-1206 # 7888 <malloc+0x182c>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	25e080e7          	jalr	606(ra) # 5fa4 <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	b5650513          	add	a0,a0,-1194 # 78b0 <malloc+0x1854>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	242080e7          	jalr	578(ra) # 5fa4 <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	b6250513          	add	a0,a0,-1182 # 78d8 <malloc+0x187c>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	226080e7          	jalr	550(ra) # 5fa4 <printf>
    exit(1);
    3d86:	4505                	li	a0,1
    ...
    3d96:	b6650513          	add	a0,a0,-1178 # 78f8 <malloc+0x189c>
    3d9a:	00002097          	auipc	ra,0x2
    3d9e:	20a080e7          	jalr	522(ra) # 5fa4 <printf>
    exit(1);
    3da2:	4505                	li	a0,1
    ...
    3db2:	b6a50513          	add	a0,a0,-1174 # 7918 <malloc+0x18bc>
    3db6:	00002097          	auipc	ra,0x2
    3dba:	1ee080e7          	jalr	494(ra) # 5fa4 <printf>
    exit(1);
    3dbe:	4505                	li	a0,1
    ...
    3dce:	b7650513          	add	a0,a0,-1162 # 7940 <malloc+0x18e4>
    3dd2:	00002097          	auipc	ra,0x2
    3dd6:	1d2080e7          	jalr	466(ra) # 5fa4 <printf>
    exit(1);
    3dda:	4505                	li	a0,1
    ...
    3dea:	b7a50513          	add	a0,a0,-1158 # 7960 <malloc+0x1904>
    3dee:	00002097          	auipc	ra,0x2
    3df2:	1b6080e7          	jalr	438(ra) # 5fa4 <printf>
    exit(1);
    3df6:	4505                	li	a0,1
    ...
    3e06:	b7e50513          	add	a0,a0,-1154 # 7980 <malloc+0x1924>
    3e0a:	00002097          	auipc	ra,0x2
    3e0e:	19a080e7          	jalr	410(ra) # 5fa4 <printf>
    exit(1);
    3e12:	4505                	li	a0,1
    ...
    3e22:	b8a50513          	add	a0,a0,-1142 # 79a8 <malloc+0x194c>
    3e26:	00002097          	auipc	ra,0x2
    3e2a:	17e080e7          	jalr	382(ra) # 5fa4 <printf>
    exit(1);
    3e2e:	4505                	li	a0,1
    ...
    3e3e:	80650513          	add	a0,a0,-2042 # 7640 <malloc+0x15e4>
    3e42:	00002097          	auipc	ra,0x2
    3e46:	162080e7          	jalr	354(ra) # 5fa4 <printf>
    exit(1);
    3e4a:	4505                	li	a0,1
    ...
    3e5a:	b7250513          	add	a0,a0,-1166 # 79c8 <malloc+0x196c>
    3e5e:	00002097          	auipc	ra,0x2
    3e62:	146080e7          	jalr	326(ra) # 5fa4 <printf>
    exit(1);
    3e66:	4505                	li	a0,1
    ...
    3e76:	b7650513          	add	a0,a0,-1162 # 79e8 <malloc+0x198c>
    3e7a:	00002097          	auipc	ra,0x2
    3e7e:	12a080e7          	jalr	298(ra) # 5fa4 <printf>
    exit(1);
    3e82:	4505                	li	a0,1
    ...
    3e92:	b8a50513          	add	a0,a0,-1142 # 7a18 <malloc+0x19bc>
    3e96:	00002097          	auipc	ra,0x2
    3e9a:	10e080e7          	jalr	270(ra) # 5fa4 <printf>
    exit(1);
    3e9e:	4505                	li	a0,1
    ...
    3eae:	b8e50513          	add	a0,a0,-1138 # 7a38 <malloc+0x19dc>
    3eb2:	00002097          	auipc	ra,0x2
    3eb6:	0f2080e7          	jalr	242(ra) # 5fa4 <printf>
    exit(1);
    3eba:	4505                	li	a0,1
...
0000000000003ec4 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ed4:	b8050513          	add	a0,a0,-1152 # 7a50 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3ee6:	b6e50513          	add	a0,a0,-1170 # 7a50 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3ef8:	98c50513          	add	a0,a0,-1652 # 6880 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3f0a:	5a250513          	add	a0,a0,1442 # 74a8 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3f1c:	53850513          	add	a0,a0,1336 # 7450 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f2e:	b8e50513          	add	a0,a0,-1138 # 7ab8 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f40:	ba450513          	add	a0,a0,-1116 # 7ae0 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3f52:	b0250513          	add	a0,a0,-1278 # 7a50 <malloc+0x19f4>
    ...
    3f70:	aec50513          	add	a0,a0,-1300 # 7a58 <malloc+0x19fc>
    3f74:	00002097          	auipc	ra,0x2
    3f78:	030080e7          	jalr	48(ra) # 5fa4 <printf>
    exit(1);
    3f7c:	4505                	li	a0,1
    ...
    3f8c:	ae850513          	add	a0,a0,-1304 # 7a70 <malloc+0x1a14>
    3f90:	00002097          	auipc	ra,0x2
    3f94:	014080e7          	jalr	20(ra) # 5fa4 <printf>
    exit(1);
    3f98:	4505                	li	a0,1
    ...
    3fa8:	ae450513          	add	a0,a0,-1308 # 7a88 <malloc+0x1a2c>
    3fac:	00002097          	auipc	ra,0x2
    3fb0:	ff8080e7          	jalr	-8(ra) # 5fa4 <printf>
    exit(1);
    3fb4:	4505                	li	a0,1
    ...
    3fc4:	ae050513          	add	a0,a0,-1312 # 7aa0 <malloc+0x1a44>
    3fc8:	00002097          	auipc	ra,0x2
    3fcc:	fdc080e7          	jalr	-36(ra) # 5fa4 <printf>
    exit(1);
    3fd0:	4505                	li	a0,1
    ...
    3fe0:	47c50513          	add	a0,a0,1148 # 7458 <malloc+0x13fc>
    3fe4:	00002097          	auipc	ra,0x2
    3fe8:	fc0080e7          	jalr	-64(ra) # 5fa4 <printf>
    exit(1);
    3fec:	4505                	li	a0,1
    ...
    3ffc:	ac850513          	add	a0,a0,-1336 # 7ac0 <malloc+0x1a64>
    4000:	00002097          	auipc	ra,0x2
    4004:	fa4080e7          	jalr	-92(ra) # 5fa4 <printf>
    exit(1);
    4008:	4505                	li	a0,1
    ...
    4018:	ad450513          	add	a0,a0,-1324 # 7ae8 <malloc+0x1a8c>
    401c:	00002097          	auipc	ra,0x2
    4020:	f88080e7          	jalr	-120(ra) # 5fa4 <printf>
    exit(1);
    4024:	4505                	li	a0,1
    ...
    4034:	ad850513          	add	a0,a0,-1320 # 7b08 <malloc+0x1aac>
    4038:	00002097          	auipc	ra,0x2
    403c:	f6c080e7          	jalr	-148(ra) # 5fa4 <printf>
    exit(1);
    4040:	4505                	li	a0,1
...
000000000000404a <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    4060:	acc50513          	add	a0,a0,-1332 # 7b28 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    407c:	ab050513          	add	a0,a0,-1360 # 7b28 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4090:	ae450513          	add	a0,a0,-1308 # 7b70 <malloc+0x1b14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    40a8:	acc50513          	add	a0,a0,-1332 # 7b70 <malloc+0x1b14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40bc:	ab850513          	add	a0,a0,-1352 # 7b70 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40d0:	aa450513          	add	a0,a0,-1372 # 7b70 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40e4:	a9058593          	add	a1,a1,-1392 # 7b70 <malloc+0x1b14>
    40e8:	00002517          	auipc	a0,0x2
    40ec:	28850513          	add	a0,a0,648 # 6370 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    4100:	a2c50513          	add	a0,a0,-1492 # 7b28 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    4116:	76e50513          	add	a0,a0,1902 # 6880 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    412c:	75850513          	add	a0,a0,1880 # 6880 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    4140:	0cc58593          	add	a1,a1,204 # 6208 <malloc+0x1ac>
  ...
  close(fd);
    ...
    416c:	9c850513          	add	a0,a0,-1592 # 7b30 <malloc+0x1ad4>
    4170:	00002097          	auipc	ra,0x2
    4174:	e34080e7          	jalr	-460(ra) # 5fa4 <printf>
    exit(1);
    4178:	4505                	li	a0,1
    ...
    4188:	9cc50513          	add	a0,a0,-1588 # 7b50 <malloc+0x1af4>
    418c:	00002097          	auipc	ra,0x2
    4190:	e18080e7          	jalr	-488(ra) # 5fa4 <printf>
    exit(1);
    4194:	4505                	li	a0,1
    ...
    41a4:	9e050513          	add	a0,a0,-1568 # 7b80 <malloc+0x1b24>
    41a8:	00002097          	auipc	ra,0x2
    41ac:	dfc080e7          	jalr	-516(ra) # 5fa4 <printf>
    exit(1);
    41b0:	4505                	li	a0,1
    ...
    41c0:	9c450513          	add	a0,a0,-1596 # 7b80 <malloc+0x1b24>
    41c4:	00002097          	auipc	ra,0x2
    41c8:	de0080e7          	jalr	-544(ra) # 5fa4 <printf>
    exit(1);
    41cc:	4505                	li	a0,1
    ...
    41dc:	9d050513          	add	a0,a0,-1584 # 7ba8 <malloc+0x1b4c>
    41e0:	00002097          	auipc	ra,0x2
    41e4:	dc4080e7          	jalr	-572(ra) # 5fa4 <printf>
    exit(1);
    41e8:	4505                	li	a0,1
    ...
    41f8:	9dc50513          	add	a0,a0,-1572 # 7bd0 <malloc+0x1b74>
    41fc:	00002097          	auipc	ra,0x2
    4200:	da8080e7          	jalr	-600(ra) # 5fa4 <printf>
    exit(1);
    4204:	4505                	li	a0,1
    ...
    4214:	9e850513          	add	a0,a0,-1560 # 7bf8 <malloc+0x1b9c>
    4218:	00002097          	auipc	ra,0x2
    421c:	d8c080e7          	jalr	-628(ra) # 5fa4 <printf>
    exit(1);
    4220:	4505                	li	a0,1
    ...
    4230:	9f450513          	add	a0,a0,-1548 # 7c20 <malloc+0x1bc4>
    4234:	00002097          	auipc	ra,0x2
    4238:	d70080e7          	jalr	-656(ra) # 5fa4 <printf>
    exit(1);
    423c:	4505                	li	a0,1
    ...
    424c:	9f850513          	add	a0,a0,-1544 # 7c40 <malloc+0x1be4>
    4250:	00002097          	auipc	ra,0x2
    4254:	d54080e7          	jalr	-684(ra) # 5fa4 <printf>
    exit(1);
    4258:	4505                	li	a0,1
    ...
    4268:	a0450513          	add	a0,a0,-1532 # 7c68 <malloc+0x1c0c>
    426c:	00002097          	auipc	ra,0x2
    4270:	d38080e7          	jalr	-712(ra) # 5fa4 <printf>
    exit(1);
    4274:	4505                	li	a0,1
...
000000000000427e <iref>:
{
    ...
    429c:	9e8a0a13          	add	s4,s4,-1560 # 7c80 <malloc+0x1c24>
    mkdir("");
    42a0:	00003497          	auipc	s1,0x3
    42a4:	4e848493          	add	s1,s1,1256 # 7788 <malloc+0x172c>
    link("README", "");
    42a8:	00002a97          	auipc	s5,0x2
    42ac:	0c8a8a93          	add	s5,s5,200 # 6370 <malloc+0x314>
    fd = open("xx", O_CREATE);
    42b0:	00004997          	auipc	s3,0x4
    42b4:	8c898993          	add	s3,s3,-1848 # 7b78 <malloc+0x1b1c>
    42b8:	a891                	j	430c <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42ba:	85da                	mv	a1,s6
    42bc:	00004517          	auipc	a0,0x4
    42c0:	9cc50513          	add	a0,a0,-1588 # 7c88 <malloc+0x1c2c>
    42c4:	00002097          	auipc	ra,0x2
    42c8:	ce0080e7          	jalr	-800(ra) # 5fa4 <printf>
      exit(1);
    42cc:	4505                	li	a0,1
    ...
    42dc:	9c850513          	add	a0,a0,-1592 # 7ca0 <malloc+0x1c44>
    42e0:	00002097          	auipc	ra,0x2
    42e4:	cc4080e7          	jalr	-828(ra) # 5fa4 <printf>
      exit(1);
    42e8:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4370:	13c98993          	add	s3,s3,316 # 74a8 <malloc+0x144c>
    unlink("irefd");
    4374:	00004917          	auipc	s2,0x4
    4378:	90c90913          	add	s2,s2,-1780 # 7c80 <malloc+0x1c24>
    chdir("..");
    437c:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4398:	0bc50513          	add	a0,a0,188 # 7450 <malloc+0x13f4>
...
00000000000043b8 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43c8:	8f450513          	add	a0,a0,-1804 # 7cb8 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    43ec:	8d050513          	add	a0,a0,-1840 # 7cb8 <malloc+0x1c5c>
    ...
    4402:	8da50513          	add	a0,a0,-1830 # 7cd8 <malloc+0x1c7c>
    4406:	00002097          	auipc	ra,0x2
    440a:	b9e080e7          	jalr	-1122(ra) # 5fa4 <printf>
      exit(1);
    440e:	4505                	li	a0,1
    ...
    441e:	8a650513          	add	a0,a0,-1882 # 7cc0 <malloc+0x1c64>
    4422:	00002097          	auipc	ra,0x2
    4426:	b82080e7          	jalr	-1150(ra) # 5fa4 <printf>
    exit(1);
    442a:	4505                	li	a0,1
    ...
    443a:	5ea50513          	add	a0,a0,1514 # 6a20 <malloc+0x9c4>
    443e:	00002097          	auipc	ra,0x2
    4442:	b66080e7          	jalr	-1178(ra) # 5fa4 <printf>
    exit(1);
    4446:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4468:	85450513          	add	a0,a0,-1964 # 7cb8 <malloc+0x1c5c>
    ...
    447c:	79850513          	add	a0,a0,1944 # 6c10 <malloc+0xbb4>
    4480:	00002097          	auipc	ra,0x2
    4484:	b24080e7          	jalr	-1244(ra) # 5fa4 <printf>
    exit(1);
    4488:	4505                	li	a0,1
...
00000000000044aa <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44ba:	84a50513          	add	a0,a0,-1974 # 7d00 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44e6:	81e50513          	add	a0,a0,-2018 # 7d00 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    451e:	6c650513          	add	a0,a0,1734 # 6be0 <malloc+0xb84>
    4522:	00002097          	auipc	ra,0x2
    4526:	a82080e7          	jalr	-1406(ra) # 5fa4 <printf>
    exit(1);
    452a:	4505                	li	a0,1
    ...
    4538:	7cc48493          	add	s1,s1,1996 # 7d00 <malloc+0x1ca4>
    453c:	4581                	li	a1,0
    453e:	8526                	mv	a0,s1
    ...
    4560:	7a450513          	add	a0,a0,1956 # 7d00 <malloc+0x1ca4>
...
0000000000004580 <killstatus>:
{
  ...
  exit(0);
    ...
    45e6:	43e50513          	add	a0,a0,1086 # 6a20 <malloc+0x9c4>
    45ea:	00002097          	auipc	ra,0x2
    45ee:	9ba080e7          	jalr	-1606(ra) # 5fa4 <printf>
      exit(1);
    45f2:	4505                	li	a0,1
    ...
    460c:	70850513          	add	a0,a0,1800 # 7d10 <malloc+0x1cb4>
    4610:	00002097          	auipc	ra,0x2
    4614:	994080e7          	jalr	-1644(ra) # 5fa4 <printf>
       exit(1);
    4618:	4505                	li	a0,1
...
0000000000004622 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    464c:	59850513          	add	a0,a0,1432 # 6be0 <malloc+0xb84>
    4650:	00002097          	auipc	ra,0x2
    4654:	954080e7          	jalr	-1708(ra) # 5fa4 <printf>
    exit(1);
    4658:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    467a:	3aa50513          	add	a0,a0,938 # 6a20 <malloc+0x9c4>
    467e:	00002097          	auipc	ra,0x2
    4682:	926080e7          	jalr	-1754(ra) # 5fa4 <printf>
    exit(1);
    4686:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    46be:	b4e58593          	add	a1,a1,-1202 # 6208 <malloc+0x1ac>
    ...
    46e8:	33c50513          	add	a0,a0,828 # 6a20 <malloc+0x9c4>
    46ec:	00002097          	auipc	ra,0x2
    46f0:	8b8080e7          	jalr	-1864(ra) # 5fa4 <printf>
     exit(1);
    46f4:	4505                	li	a0,1
    ...
    4704:	63050513          	add	a0,a0,1584 # 7d30 <malloc+0x1cd4>
    4708:	00002097          	auipc	ra,0x2
    470c:	89c080e7          	jalr	-1892(ra) # 5fa4 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4724:	8f858593          	add	a1,a1,-1800 # e018 <buf>
    ...
    4740:	60c50513          	add	a0,a0,1548 # 7d48 <malloc+0x1cec>
    4744:	00002097          	auipc	ra,0x2
    4748:	860080e7          	jalr	-1952(ra) # 5fa4 <printf>
}
  ...
  printf("kill... ");
    ...
    476c:	5f850513          	add	a0,a0,1528 # 7d60 <malloc+0x1d04>
    4770:	00002097          	auipc	ra,0x2
    4774:	834080e7          	jalr	-1996(ra) # 5fa4 <printf>
  kill(pid1);
    4778:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    479a:	5da50513          	add	a0,a0,1498 # 7d70 <malloc+0x1d14>
    479e:	00002097          	auipc	ra,0x2
    47a2:	806080e7          	jalr	-2042(ra) # 5fa4 <printf>
  wait(0);
    47a6:	4501                	li	a0,0
...
00000000000047c6 <reparent>:
{
  ...
  exit(0);
    ...
    481a:	20a50513          	add	a0,a0,522 # 6a20 <malloc+0x9c4>
    481e:	00001097          	auipc	ra,0x1
    4822:	786080e7          	jalr	1926(ra) # 5fa4 <printf>
      exit(1);
    4826:	4505                	li	a0,1
    ...
    4836:	37650513          	add	a0,a0,886 # 6ba8 <malloc+0xb4c>
    483a:	00001097          	auipc	ra,0x1
    483e:	76a080e7          	jalr	1898(ra) # 5fa4 <printf>
        exit(1);
    4842:	4505                	li	a0,1
...
0000000000004876 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    48ac:	28050513          	add	a0,a0,640 # 6b28 <malloc+0xacc>
    48b0:	00001097          	auipc	ra,0x1
    48b4:	6f4080e7          	jalr	1780(ra) # 5fa4 <printf>
    exit(1);
    48b8:	4505                	li	a0,1
    ...
    48e0:	92c58593          	add	a1,a1,-1748 # 6208 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    49a4:	3e050513          	add	a0,a0,992 # 7d80 <malloc+0x1d24>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	5fc080e7          	jalr	1532(ra) # 5fa4 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
    ...
    49c0:	06450513          	add	a0,a0,100 # 6a20 <malloc+0x9c4>
    49c4:	00001097          	auipc	ra,0x1
    49c8:	5e0080e7          	jalr	1504(ra) # 5fa4 <printf>
    exit(1);
    49cc:	4505                	li	a0,1
    ...
    49f6:	6705                	lui	a4,0x1
      n += *(a+i);
    49f8:	0007c683          	lbu	a3,0(a5) # 6400000 <base+0x63eefe8>
    ...
    4a0c:	39850513          	add	a0,a0,920 # 7da0 <malloc+0x1d44>
    4a10:	00001097          	auipc	ra,0x1
    4a14:	594080e7          	jalr	1428(ra) # 5fa4 <printf>
    exit(1);
    4a18:	4505                	li	a0,1
...
0000000000004a2c <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a76:	5ea080e7          	jalr	1514(ra) # 605c <malloc>
    ...
    4ab0:	32450513          	add	a0,a0,804 # 7dd0 <malloc+0x1d74>
    4ab4:	00001097          	auipc	ra,0x1
    4ab8:	4f0080e7          	jalr	1264(ra) # 5fa4 <printf>
      exit(1);
    4abc:	4505                	li	a0,1
...
0000000000004ad0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b72:	29250513          	add	a0,a0,658 # 7e00 <malloc+0x1da4>
    4b76:	00001097          	auipc	ra,0x1
    4b7a:	42e080e7          	jalr	1070(ra) # 5fa4 <printf>
    exit(1);
    4b7e:	4505                	li	a0,1
    ...
    4b8e:	29e50513          	add	a0,a0,670 # 7e28 <malloc+0x1dcc>
    4b92:	00001097          	auipc	ra,0x1
    4b96:	412080e7          	jalr	1042(ra) # 5fa4 <printf>
      exit(1);
    4b9a:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4bd2:	22250513          	add	a0,a0,546 # 7df0 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4c12:	23a50513          	add	a0,a0,570 # 7e48 <malloc+0x1dec>
    4c16:	00001097          	auipc	ra,0x1
    4c1a:	38e080e7          	jalr	910(ra) # 5fa4 <printf>
    exit(1);
    4c1e:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4c4e:	1a650513          	add	a0,a0,422 # 7df0 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c74:	20050513          	add	a0,a0,512 # 7e70 <malloc+0x1e14>
    4c78:	00001097          	auipc	ra,0x1
    4c7c:	32c080e7          	jalr	812(ra) # 5fa4 <printf>
    exit(1);
    4c80:	4505                	li	a0,1
...
0000000000004c94 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4cb8:	1d478793          	add	a5,a5,468 # 7e88 <malloc+0x1e2c>
    4cbc:	f6f43823          	sd	a5,-144(s0)
    4cc0:	00003797          	auipc	a5,0x3
    4cc4:	1d078793          	add	a5,a5,464 # 7e90 <malloc+0x1e34>
    4cc8:	f6f43c23          	sd	a5,-136(s0)
    4ccc:	00003797          	auipc	a5,0x3
    4cd0:	1cc78793          	add	a5,a5,460 # 7e98 <malloc+0x1e3c>
    4cd4:	f8f43023          	sd	a5,-128(s0)
    4cd8:	00003797          	auipc	a5,0x3
    4cdc:	1c878793          	add	a5,a5,456 # 7ea0 <malloc+0x1e44>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4d34:	2e8a0a13          	add	s4,s4,744 # e018 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d4a:	0e250513          	add	a0,a0,226 # 6e28 <malloc+0xdcc>
    4d4e:	00001097          	auipc	ra,0x1
    4d52:	256080e7          	jalr	598(ra) # 5fa4 <printf>
      exit(1);
    4d56:	4505                	li	a0,1
    ...
    4dc4:	0e850513          	add	a0,a0,232 # 7ea8 <malloc+0x1e4c>
    4dc8:	00001097          	auipc	ra,0x1
    4dcc:	1dc080e7          	jalr	476(ra) # 5fa4 <printf>
        exit(1);
    4dd0:	4505                	li	a0,1
    ...
    4dde:	0de50513          	add	a0,a0,222 # 7eb8 <malloc+0x1e5c>
    4de2:	00001097          	auipc	ra,0x1
    4de6:	1c2080e7          	jalr	450(ra) # 5fa4 <printf>
          exit(1);
    4dea:	4505                	li	a0,1
    ...
    4e04:	0d050513          	add	a0,a0,208 # 7ed0 <malloc+0x1e74>
    4e08:	00001097          	auipc	ra,0x1
    4e0c:	19c080e7          	jalr	412(ra) # 5fa4 <printf>
          exit(1);
    4e10:	4505                	li	a0,1
    ...
    4e34:	1e878793          	add	a5,a5,488 # e018 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e8c:	05850513          	add	a0,a0,88 # 7ee0 <malloc+0x1e84>
    4e90:	00001097          	auipc	ra,0x1
    4e94:	114080e7          	jalr	276(ra) # 5fa4 <printf>
      exit(1);
    4e98:	4505                	li	a0,1
...
0000000000004ec0 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eee:	00eb8b93          	add	s7,s7,14 # 7ef8 <malloc+0x1e9c>
  for(i = 0; i < N; i++){
    ...
    4f30:	fd450513          	add	a0,a0,-44 # 7f00 <malloc+0x1ea4>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	070080e7          	jalr	112(ra) # 5fa4 <printf>
        exit(1);
    4f3c:	4505                	li	a0,1
    ...
    4f4e:	fae50513          	add	a0,a0,-82 # 7ef8 <malloc+0x1e9c>
  ...
  fd = open(".", 0);
    ...
    4f86:	8fe50513          	add	a0,a0,-1794 # 6880 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ffe:	f2650513          	add	a0,a0,-218 # 7f20 <malloc+0x1ec4>
    5002:	00001097          	auipc	ra,0x1
    5006:	fa2080e7          	jalr	-94(ra) # 5fa4 <printf>
        exit(1);
    500a:	4505                	li	a0,1
    ...
    501e:	f2650513          	add	a0,a0,-218 # 7f40 <malloc+0x1ee4>
    5022:	00001097          	auipc	ra,0x1
    5026:	f82080e7          	jalr	-126(ra) # 5fa4 <printf>
        exit(1);
    502a:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    5056:	f1650513          	add	a0,a0,-234 # 7f68 <malloc+0x1f0c>
    505a:	00001097          	auipc	ra,0x1
    505e:	f4a080e7          	jalr	-182(ra) # 5fa4 <printf>
    exit(1);
    5062:	4505                	li	a0,1
    ...
    5072:	9b250513          	add	a0,a0,-1614 # 6a20 <malloc+0x9c4>
    5076:	00001097          	auipc	ra,0x1
    507a:	f2e080e7          	jalr	-210(ra) # 5fa4 <printf>
      exit(1);
    507e:	4505                	li	a0,1
...
000000000000521c <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    525c:	dc090913          	add	s2,s2,-576 # e018 <buf>
  for(i = 0; i < N; i++){
    5260:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    52a4:	d0050513          	add	a0,a0,-768 # 7fa0 <malloc+0x1f44>
  ...
  for(i = 0; ; i++){
    ...
    52ba:	d6290913          	add	s2,s2,-670 # e018 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    5308:	cac50513          	add	a0,a0,-852 # 7fb0 <malloc+0x1f54>
    530c:	00001097          	auipc	ra,0x1
    5310:	c98080e7          	jalr	-872(ra) # 5fa4 <printf>
    exit(1);
    5314:	4505                	li	a0,1
    ...
    5324:	cb050513          	add	a0,a0,-848 # 7fd0 <malloc+0x1f74>
    5328:	00001097          	auipc	ra,0x1
    532c:	c7c080e7          	jalr	-900(ra) # 5fa4 <printf>
      exit(1);
    5330:	4505                	li	a0,1
    ...
    5340:	cb450513          	add	a0,a0,-844 # 7ff0 <malloc+0x1f94>
    5344:	00001097          	auipc	ra,0x1
    5348:	c60080e7          	jalr	-928(ra) # 5fa4 <printf>
    exit(1);
    534c:	4505                	li	a0,1
    ...
    535c:	cb850513          	add	a0,a0,-840 # 8010 <malloc+0x1fb4>
    5360:	00001097          	auipc	ra,0x1
    5364:	c44080e7          	jalr	-956(ra) # 5fa4 <printf>
      exit(1);
    5368:	4505                	li	a0,1
    ...
    5378:	cbc50513          	add	a0,a0,-836 # 8030 <malloc+0x1fd4>
    537c:	00001097          	auipc	ra,0x1
    5380:	c28080e7          	jalr	-984(ra) # 5fa4 <printf>
      exit(1);
    5384:	4505                	li	a0,1
    ...
    5394:	cb850513          	add	a0,a0,-840 # 8048 <malloc+0x1fec>
    5398:	00001097          	auipc	ra,0x1
    539c:	c0c080e7          	jalr	-1012(ra) # 5fa4 <printf>
      exit(1);
    53a0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    53c2:	be250513          	add	a0,a0,-1054 # 7fa0 <malloc+0x1f44>
    ...
    53e6:	c8650513          	add	a0,a0,-890 # 8068 <malloc+0x200c>
    53ea:	00001097          	auipc	ra,0x1
    53ee:	bba080e7          	jalr	-1094(ra) # 5fa4 <printf>
    exit(1);
    53f2:	4505                	li	a0,1
...
00000000000053fc <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    541c:	c7050513          	add	a0,a0,-912 # 8088 <malloc+0x202c>
    5420:	00001097          	auipc	ra,0x1
    5424:	b84080e7          	jalr	-1148(ra) # 5fa4 <printf>
  for(nfiles = 0; ; nfiles++){
    5428:	4481                	li	s1,0
    name[0] = 'f';
    ...
    543c:	c60c8c93          	add	s9,s9,-928 # 8098 <malloc+0x203c>
    name[0] = 'f';
    ...
    548a:	b1e080e7          	jalr	-1250(ra) # 5fa4 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    54ac:	c0050513          	add	a0,a0,-1024 # 80a8 <malloc+0x204c>
    54b0:	00001097          	auipc	ra,0x1
    54b4:	af4080e7          	jalr	-1292(ra) # 5fa4 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5522:	baa50513          	add	a0,a0,-1110 # 80c8 <malloc+0x206c>
    5526:	00001097          	auipc	ra,0x1
    552a:	a7e080e7          	jalr	-1410(ra) # 5fa4 <printf>
}
    ...
    5550:	acca8a93          	add	s5,s5,-1332 # e018 <buf>
      if(cc < BSIZE)
    ...
    5578:	b4450513          	add	a0,a0,-1212 # 80b8 <malloc+0x205c>
    557c:	00001097          	auipc	ra,0x1
    5580:	a28080e7          	jalr	-1496(ra) # 5fa4 <printf>
    close(fd);
    5584:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    55aa:	b3a50513          	add	a0,a0,-1222 # 80e0 <malloc+0x2084>
    55ae:	00001097          	auipc	ra,0x1
    55b2:	9f6080e7          	jalr	-1546(ra) # 5fa4 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    55da:	b3250513          	add	a0,a0,-1230 # 8108 <malloc+0x20ac>
    55de:	00001097          	auipc	ra,0x1
    55e2:	9c6080e7          	jalr	-1594(ra) # 5fa4 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55fe:	af650513          	add	a0,a0,-1290 # 80f0 <malloc+0x2094>
    5602:	00001097          	auipc	ra,0x1
    5606:	9a2080e7          	jalr	-1630(ra) # 5fa4 <printf>
    exit(1);
    560a:	4505                	li	a0,1
    ...
    5626:	aee50513          	add	a0,a0,-1298 # 8110 <malloc+0x20b4>
    562a:	00001097          	auipc	ra,0x1
    562e:	97a080e7          	jalr	-1670(ra) # 5fa4 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    567e:	a9e50513          	add	a0,a0,-1378 # 8118 <malloc+0x20bc>
    5682:	00001097          	auipc	ra,0x1
    5686:	922080e7          	jalr	-1758(ra) # 5fa4 <printf>
          return 1;
    568a:	4505                	li	a0,1
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56e8:	b2498993          	add	s3,s3,-1244 # 6208 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    571a:	a5a50513          	add	a0,a0,-1446 # 8170 <malloc+0x2114>
    571e:	00001097          	auipc	ra,0x1
    5722:	886080e7          	jalr	-1914(ra) # 5fa4 <printf>
        exit(1);
    5726:	4505                	li	a0,1
    ...
    573a:	9fa50513          	add	a0,a0,-1542 # 8130 <malloc+0x20d4>
    573e:	00001097          	auipc	ra,0x1
    5742:	866080e7          	jalr	-1946(ra) # 5fa4 <printf>
    exit(1);
    5746:	4505                	li	a0,1
    ...
    575a:	9fa50513          	add	a0,a0,-1542 # 8150 <malloc+0x20f4>
    575e:	00001097          	auipc	ra,0x1
    5762:	846080e7          	jalr	-1978(ra) # 5fa4 <printf>
    exit(1);
    5766:	4505                	li	a0,1
  ...
  while(1){
    ...
    57ae:	9e650513          	add	a0,a0,-1562 # 8190 <malloc+0x2134>
    57b2:	00000097          	auipc	ra,0x0
    57b6:	7f2080e7          	jalr	2034(ra) # 5fa4 <printf>
      exit(1);
    57ba:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    580c:	9a8b8b93          	add	s7,s7,-1624 # 81b0 <malloc+0x2154>
    int free0 = countfree();
    int free1 = 0;
    if (runtests(quicktests, justone, continuous)) {
    5810:	00005b17          	auipc	s6,0x5
    5814:	ba0b0b13          	add	s6,s6,-1120 # a3b0 <quicktests>
      if(continuous != 2) {
    5818:	4a09                	li	s4,2
      }
    }
    ...
    581e:	f66c0c13          	add	s8,s8,-154 # a780 <slowtests>
        printf("usertests slow tests starting\n");
    5822:	00003d17          	auipc	s10,0x3
    5826:	9a6d0d13          	add	s10,s10,-1626 # 81c8 <malloc+0x216c>
          return 1;
        }
      }
    }
    ...
    582e:	9bec8c93          	add	s9,s9,-1602 # 81e8 <malloc+0x218c>
    5832:	a839                	j	5850 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    5834:	856a                	mv	a0,s10
    5836:	00000097          	auipc	ra,0x0
    583a:	76e080e7          	jalr	1902(ra) # 5fa4 <printf>
    ...
    5856:	752080e7          	jalr	1874(ra) # 5fa4 <printf>
    int free0 = countfree();
    ...
    58a2:	706080e7          	jalr	1798(ra) # 5fa4 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    590a:	91258593          	add	a1,a1,-1774 # 8218 <malloc+0x21bc>
  ...
  char *justone = 0;
    ...
    5928:	8fc58593          	add	a1,a1,-1796 # 8220 <malloc+0x21c4>
    ...
    593e:	93658593          	add	a1,a1,-1738 # 8270 <malloc+0x2214>
  ...
  int continuous = 0;
    ...
    596a:	8c250513          	add	a0,a0,-1854 # 8228 <malloc+0x21cc>
    596e:	00000097          	auipc	ra,0x0
    5972:	636080e7          	jalr	1590(ra) # 5fa4 <printf>
    exit(1);
    5976:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5990:	8cc50513          	add	a0,a0,-1844 # 8258 <malloc+0x21fc>
    5994:	00000097          	auipc	ra,0x0
    5998:	610080e7          	jalr	1552(ra) # 5fa4 <printf>
  exit(0);
    599c:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5cdc:	1101                	add	sp,sp,-32
    5cde:	ec06                	sd	ra,24(sp)
    5ce0:	e822                	sd	s0,16(sp)
    5ce2:	1000                	add	s0,sp,32
    5ce4:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5ce8:	4605                	li	a2,1
    5cea:	fef40593          	add	a1,s0,-17
    5cee:	00000097          	auipc	ra,0x0
    5cf2:	f5e080e7          	jalr	-162(ra) # 5c4c <write>
}
    5cf6:	60e2                	ld	ra,24(sp)
    5cf8:	6442                	ld	s0,16(sp)
    5cfa:	6105                	add	sp,sp,32
    5cfc:	8082                	ret

0000000000005cfe <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5cfe:	7139                	add	sp,sp,-64
    5d00:	fc06                	sd	ra,56(sp)
    5d02:	f822                	sd	s0,48(sp)
    5d04:	f426                	sd	s1,40(sp)
    5d06:	0080                	add	s0,sp,64
    5d08:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5d0a:	c299                	beqz	a3,5d10 <printint+0x12>
    5d0c:	0805cb63          	bltz	a1,5da2 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5d10:	2581                	sext.w	a1,a1
  neg = 0;
    5d12:	4881                	li	a7,0
    5d14:	fc040693          	add	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5d1a:	2601                	sext.w	a2,a2
    5d1c:	00003517          	auipc	a0,0x3
    5d20:	91c50513          	add	a0,a0,-1764 # 8638 <digits>
    5d24:	883a                	mv	a6,a4
    5d26:	2705                	addw	a4,a4,1
    5d28:	02c5f7bb          	remuw	a5,a1,a2
    5d2c:	1782                	sll	a5,a5,0x20
    5d2e:	9381                	srl	a5,a5,0x20
    5d30:	97aa                	add	a5,a5,a0
    5d32:	0007c783          	lbu	a5,0(a5)
    5d36:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5d3a:	0005879b          	sext.w	a5,a1
    5d3e:	02c5d5bb          	divuw	a1,a1,a2
    5d42:	0685                	add	a3,a3,1
    5d44:	fec7f0e3          	bgeu	a5,a2,5d24 <printint+0x26>
  if(neg)
    5d48:	00088c63          	beqz	a7,5d60 <printint+0x62>
    buf[i++] = '-';
    5d4c:	fd070793          	add	a5,a4,-48
    5d50:	00878733          	add	a4,a5,s0
    5d54:	02d00793          	li	a5,45
    5d58:	fef70823          	sb	a5,-16(a4)
    5d5c:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
    5d60:	02e05c63          	blez	a4,5d98 <printint+0x9a>
    5d64:	f04a                	sd	s2,32(sp)
    5d66:	ec4e                	sd	s3,24(sp)
    5d68:	fc040793          	add	a5,s0,-64
    5d6c:	00e78933          	add	s2,a5,a4
    5d70:	fff78993          	add	s3,a5,-1
    5d74:	99ba                	add	s3,s3,a4
    5d76:	377d                	addw	a4,a4,-1
    5d78:	1702                	sll	a4,a4,0x20
    5d7a:	9301                	srl	a4,a4,0x20
    5d7c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d80:	fff94583          	lbu	a1,-1(s2)
    5d84:	8526                	mv	a0,s1
    5d86:	00000097          	auipc	ra,0x0
    5d8a:	f56080e7          	jalr	-170(ra) # 5cdc <putc>
  while(--i >= 0)
    5d8e:	197d                	add	s2,s2,-1
    5d90:	ff3918e3          	bne	s2,s3,5d80 <printint+0x82>
    5d94:	7902                	ld	s2,32(sp)
    5d96:	69e2                	ld	s3,24(sp)
}
    5d98:	70e2                	ld	ra,56(sp)
    5d9a:	7442                	ld	s0,48(sp)
    5d9c:	74a2                	ld	s1,40(sp)
    5d9e:	6121                	add	sp,sp,64
    5da0:	8082                	ret
    x = -xx;
    5da2:	40b005bb          	negw	a1,a1
    neg = 1;
    5da6:	4885                	li	a7,1
    x = -xx;
    5da8:	b7b5                	j	5d14 <printint+0x16>

0000000000005daa <vprintf>:
}
...
{
    5daa:	715d                	add	sp,sp,-80
    5dac:	e486                	sd	ra,72(sp)
    5dae:	e0a2                	sd	s0,64(sp)
    5db0:	f84a                	sd	s2,48(sp)
    5db2:	0880                	add	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5db4:	0005c903          	lbu	s2,0(a1)
    5db8:	1a090a63          	beqz	s2,5f6c <vprintf+0x1c2>
    5dbc:	fc26                	sd	s1,56(sp)
    5dbe:	f44e                	sd	s3,40(sp)
    5dc0:	f052                	sd	s4,32(sp)
    5dc2:	ec56                	sd	s5,24(sp)
    5dc4:	e85a                	sd	s6,16(sp)
    5dc6:	e45e                	sd	s7,8(sp)
    5dc8:	8aaa                	mv	s5,a0
    5dca:	8bb2                	mv	s7,a2
    5dcc:	00158493          	add	s1,a1,1
  state = 0;
    5dd0:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5dd2:	02500a13          	li	s4,37
    5dd6:	4b55                	li	s6,21
    5dd8:	a839                	j	5df6 <vprintf+0x4c>
        putc(fd, c);
    5dda:	85ca                	mv	a1,s2
    5ddc:	8556                	mv	a0,s5
    5dde:	00000097          	auipc	ra,0x0
    5de2:	efe080e7          	jalr	-258(ra) # 5cdc <putc>
    5de6:	a019                	j	5dec <vprintf+0x42>
    } else if(state == '%'){
    5de8:	01498d63          	beq	s3,s4,5e02 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    5dec:	0485                	add	s1,s1,1
    5dee:	fff4c903          	lbu	s2,-1(s1)
    5df2:	16090763          	beqz	s2,5f60 <vprintf+0x1b6>
    if(state == 0){
    5df6:	fe0999e3          	bnez	s3,5de8 <vprintf+0x3e>
      if(c == '%'){
    5dfa:	ff4910e3          	bne	s2,s4,5dda <vprintf+0x30>
        state = '%';
    5dfe:	89d2                	mv	s3,s4
    5e00:	b7f5                	j	5dec <vprintf+0x42>
      if(c == 'd'){
    5e02:	13490463          	beq	s2,s4,5f2a <vprintf+0x180>
    5e06:	f9d9079b          	addw	a5,s2,-99
    5e0a:	0ff7f793          	zext.b	a5,a5
    5e0e:	12fb6763          	bltu	s6,a5,5f3c <vprintf+0x192>
    5e12:	f9d9079b          	addw	a5,s2,-99
    5e16:	0ff7f713          	zext.b	a4,a5
    5e1a:	12eb6163          	bltu	s6,a4,5f3c <vprintf+0x192>
    5e1e:	00271793          	sll	a5,a4,0x2
    5e22:	00002717          	auipc	a4,0x2
    5e26:	7be70713          	add	a4,a4,1982 # 85e0 <malloc+0x2584>
    5e2a:	97ba                	add	a5,a5,a4
    5e2c:	439c                	lw	a5,0(a5)
    5e2e:	97ba                	add	a5,a5,a4
    5e30:	8782                	jr	a5
    ...
    5e44:	ebe080e7          	jalr	-322(ra) # 5cfe <printint>
    5e48:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5e4a:	4981                	li	s3,0
    5e4c:	b745                	j	5dec <vprintf+0x42>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5e4e:	008b8913          	add	s2,s7,8
    5e52:	4681                	li	a3,0
    5e54:	4629                	li	a2,10
    5e56:	000ba583          	lw	a1,0(s7)
    5e5a:	8556                	mv	a0,s5
    5e5c:	00000097          	auipc	ra,0x0
    5e60:	ea2080e7          	jalr	-350(ra) # 5cfe <printint>
    5e64:	8bca                	mv	s7,s2
      state = 0;
    5e66:	4981                	li	s3,0
    5e68:	b751                	j	5dec <vprintf+0x42>
        printint(fd, va_arg(ap, int), 16, 0);
    5e6a:	008b8913          	add	s2,s7,8
    5e6e:	4681                	li	a3,0
    5e70:	4641                	li	a2,16
    5e72:	000ba583          	lw	a1,0(s7)
    5e76:	8556                	mv	a0,s5
    5e78:	00000097          	auipc	ra,0x0
    5e7c:	e86080e7          	jalr	-378(ra) # 5cfe <printint>
    5e80:	8bca                	mv	s7,s2
      state = 0;
    5e82:	4981                	li	s3,0
    5e84:	b7a5                	j	5dec <vprintf+0x42>
    5e86:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5e88:	008b8c13          	add	s8,s7,8
    5e8c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5e90:	03000593          	li	a1,48
    5e94:	8556                	mv	a0,s5
    5e96:	00000097          	auipc	ra,0x0
    5e9a:	e46080e7          	jalr	-442(ra) # 5cdc <putc>
  putc(fd, 'x');
    5e9e:	07800593          	li	a1,120
    5ea2:	8556                	mv	a0,s5
    5ea4:	00000097          	auipc	ra,0x0
    5ea8:	e38080e7          	jalr	-456(ra) # 5cdc <putc>
    5eac:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5eae:	00002b97          	auipc	s7,0x2
    5eb2:	78ab8b93          	add	s7,s7,1930 # 8638 <digits>
    5eb6:	03c9d793          	srl	a5,s3,0x3c
    5eba:	97de                	add	a5,a5,s7
    5ebc:	0007c583          	lbu	a1,0(a5)
    5ec0:	8556                	mv	a0,s5
    5ec2:	00000097          	auipc	ra,0x0
    5ec6:	e1a080e7          	jalr	-486(ra) # 5cdc <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5eca:	0992                	sll	s3,s3,0x4
    5ecc:	397d                	addw	s2,s2,-1
    5ece:	fe0914e3          	bnez	s2,5eb6 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5ed2:	8be2                	mv	s7,s8
      state = 0;
    5ed4:	4981                	li	s3,0
    5ed6:	6c02                	ld	s8,0(sp)
    5ed8:	bf11                	j	5dec <vprintf+0x42>
        s = va_arg(ap, char*);
    5eda:	008b8993          	add	s3,s7,8
    5ede:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5ee2:	02090163          	beqz	s2,5f04 <vprintf+0x15a>
        while(*s != 0){
    5ee6:	00094583          	lbu	a1,0(s2)
    5eea:	c9a5                	beqz	a1,5f5a <vprintf+0x1b0>
          putc(fd, *s);
    5eec:	8556                	mv	a0,s5
    5eee:	00000097          	auipc	ra,0x0
    5ef2:	dee080e7          	jalr	-530(ra) # 5cdc <putc>
          s++;
    5ef6:	0905                	add	s2,s2,1
        while(*s != 0){
    5ef8:	00094583          	lbu	a1,0(s2)
    5efc:	f9e5                	bnez	a1,5eec <vprintf+0x142>
        s = va_arg(ap, char*);
    5efe:	8bce                	mv	s7,s3
      state = 0;
    5f00:	4981                	li	s3,0
    5f02:	b5ed                	j	5dec <vprintf+0x42>
          s = "(null)";
    5f04:	00002917          	auipc	s2,0x2
    5f08:	6b490913          	add	s2,s2,1716 # 85b8 <malloc+0x255c>
        while(*s != 0){
    5f0c:	02800593          	li	a1,40
    5f10:	bff1                	j	5eec <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5f12:	008b8913          	add	s2,s7,8
    5f16:	000bc583          	lbu	a1,0(s7)
    5f1a:	8556                	mv	a0,s5
    5f1c:	00000097          	auipc	ra,0x0
    5f20:	dc0080e7          	jalr	-576(ra) # 5cdc <putc>
    5f24:	8bca                	mv	s7,s2
      state = 0;
    5f26:	4981                	li	s3,0
    5f28:	b5d1                	j	5dec <vprintf+0x42>
        putc(fd, c);
    5f2a:	02500593          	li	a1,37
    5f2e:	8556                	mv	a0,s5
    5f30:	00000097          	auipc	ra,0x0
    5f34:	dac080e7          	jalr	-596(ra) # 5cdc <putc>
      state = 0;
    5f38:	4981                	li	s3,0
    5f3a:	bd4d                	j	5dec <vprintf+0x42>
        putc(fd, '%');
    5f3c:	02500593          	li	a1,37
    5f40:	8556                	mv	a0,s5
    5f42:	00000097          	auipc	ra,0x0
    5f46:	d9a080e7          	jalr	-614(ra) # 5cdc <putc>
        putc(fd, c);
    5f4a:	85ca                	mv	a1,s2
    5f4c:	8556                	mv	a0,s5
    5f4e:	00000097          	auipc	ra,0x0
    5f52:	d8e080e7          	jalr	-626(ra) # 5cdc <putc>
      state = 0;
    5f56:	4981                	li	s3,0
    5f58:	bd51                	j	5dec <vprintf+0x42>
        s = va_arg(ap, char*);
    5f5a:	8bce                	mv	s7,s3
      state = 0;
    5f5c:	4981                	li	s3,0
    5f5e:	b579                	j	5dec <vprintf+0x42>
    5f60:	74e2                	ld	s1,56(sp)
    5f62:	79a2                	ld	s3,40(sp)
    5f64:	7a02                	ld	s4,32(sp)
    5f66:	6ae2                	ld	s5,24(sp)
    5f68:	6b42                	ld	s6,16(sp)
    5f6a:	6ba2                	ld	s7,8(sp)
    }
  }
}
    5f6c:	60a6                	ld	ra,72(sp)
    5f6e:	6406                	ld	s0,64(sp)
    5f70:	7942                	ld	s2,48(sp)
    5f72:	6161                	add	sp,sp,80
    5f74:	8082                	ret

0000000000005f76 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f76:	715d                	add	sp,sp,-80
    5f78:	ec06                	sd	ra,24(sp)
    5f7a:	e822                	sd	s0,16(sp)
    5f7c:	1000                	add	s0,sp,32
    5f7e:	e010                	sd	a2,0(s0)
    5f80:	e414                	sd	a3,8(s0)
    5f82:	e818                	sd	a4,16(s0)
    5f84:	ec1c                	sd	a5,24(s0)
    5f86:	03043023          	sd	a6,32(s0)
    5f8a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f8e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f92:	8622                	mv	a2,s0
    5f94:	00000097          	auipc	ra,0x0
    5f98:	e16080e7          	jalr	-490(ra) # 5daa <vprintf>
}
    5f9c:	60e2                	ld	ra,24(sp)
    5f9e:	6442                	ld	s0,16(sp)
    5fa0:	6161                	add	sp,sp,80
    5fa2:	8082                	ret

0000000000005fa4 <printf>:

void
printf(const char *fmt, ...)
{
    5fa4:	711d                	add	sp,sp,-96
    5fa6:	ec06                	sd	ra,24(sp)
    5fa8:	e822                	sd	s0,16(sp)
    5faa:	1000                	add	s0,sp,32
    5fac:	e40c                	sd	a1,8(s0)
    5fae:	e810                	sd	a2,16(s0)
    5fb0:	ec14                	sd	a3,24(s0)
    5fb2:	f018                	sd	a4,32(s0)
    5fb4:	f41c                	sd	a5,40(s0)
    5fb6:	03043823          	sd	a6,48(s0)
    5fba:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5fbe:	00840613          	add	a2,s0,8
    5fc2:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5fc6:	85aa                	mv	a1,a0
    5fc8:	4505                	li	a0,1
    5fca:	00000097          	auipc	ra,0x0
    5fce:	de0080e7          	jalr	-544(ra) # 5daa <vprintf>
}
    5fd2:	60e2                	ld	ra,24(sp)
    5fd4:	6442                	ld	s0,16(sp)
    5fd6:	6125                	add	sp,sp,96
    5fd8:	8082                	ret

0000000000005fda <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5fda:	1141                	add	sp,sp,-16
    5fdc:	e422                	sd	s0,8(sp)
    5fde:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fe0:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fe4:	00005797          	auipc	a5,0x5
    5fe8:	80c7b783          	ld	a5,-2036(a5) # a7f0 <freep>
    5fec:	a02d                	j	6016 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fee:	4618                	lw	a4,8(a2)
    5ff0:	9f2d                	addw	a4,a4,a1
    5ff2:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5ff6:	6398                	ld	a4,0(a5)
    5ff8:	6310                	ld	a2,0(a4)
    5ffa:	a83d                	j	6038 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5ffc:	ff852703          	lw	a4,-8(a0)
    6000:	9f31                	addw	a4,a4,a2
    6002:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    6004:	ff053683          	ld	a3,-16(a0)
    6008:	a091                	j	604c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    600a:	6398                	ld	a4,0(a5)
    600c:	00e7e463          	bltu	a5,a4,6014 <free+0x3a>
    6010:	00e6ea63          	bltu	a3,a4,6024 <free+0x4a>
{
    6014:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    6016:	fed7fae3          	bgeu	a5,a3,600a <free+0x30>
    601a:	6398                	ld	a4,0(a5)
    601c:	00e6e463          	bltu	a3,a4,6024 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    6020:	fee7eae3          	bltu	a5,a4,6014 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    6024:	ff852583          	lw	a1,-8(a0)
    6028:	6390                	ld	a2,0(a5)
    602a:	02059813          	sll	a6,a1,0x20
    602e:	01c85713          	srl	a4,a6,0x1c
    6032:	9736                	add	a4,a4,a3
    6034:	fae60de3          	beq	a2,a4,5fee <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    6038:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    603c:	4790                	lw	a2,8(a5)
    603e:	02061593          	sll	a1,a2,0x20
    6042:	01c5d713          	srl	a4,a1,0x1c
    6046:	973e                	add	a4,a4,a5
    6048:	fae68ae3          	beq	a3,a4,5ffc <free+0x22>
    p->s.ptr = bp->s.ptr;
    604c:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    604e:	00004717          	auipc	a4,0x4
    6052:	7af73123          	sd	a5,1954(a4) # a7f0 <freep>
}
    6056:	6422                	ld	s0,8(sp)
    6058:	0141                	add	sp,sp,16
    605a:	8082                	ret

000000000000605c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    605c:	7139                	add	sp,sp,-64
    605e:	fc06                	sd	ra,56(sp)
    6060:	f822                	sd	s0,48(sp)
    6062:	f426                	sd	s1,40(sp)
    6064:	ec4e                	sd	s3,24(sp)
    6066:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6068:	02051493          	sll	s1,a0,0x20
    606c:	9081                	srl	s1,s1,0x20
    606e:	04bd                	add	s1,s1,15
    6070:	8091                	srl	s1,s1,0x4
    6072:	0014899b          	addw	s3,s1,1
    6076:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    6078:	00004517          	auipc	a0,0x4
    607c:	77853503          	ld	a0,1912(a0) # a7f0 <freep>
    6080:	c915                	beqz	a0,60b4 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6082:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    6084:	4798                	lw	a4,8(a5)
    6086:	08977e63          	bgeu	a4,s1,6122 <malloc+0xc6>
    608a:	f04a                	sd	s2,32(sp)
    608c:	e852                	sd	s4,16(sp)
    608e:	e456                	sd	s5,8(sp)
    6090:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    6092:	8a4e                	mv	s4,s3
    6094:	0009871b          	sext.w	a4,s3
    6098:	6685                	lui	a3,0x1
    609a:	00d77363          	bgeu	a4,a3,60a0 <malloc+0x44>
    609e:	6a05                	lui	s4,0x1
    60a0:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    60a4:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    60a8:	00004917          	auipc	s2,0x4
    60ac:	74890913          	add	s2,s2,1864 # a7f0 <freep>
  if(p == (char*)-1)
    60b0:	5afd                	li	s5,-1
    60b2:	a091                	j	60f6 <malloc+0x9a>
    60b4:	f04a                	sd	s2,32(sp)
    60b6:	e852                	sd	s4,16(sp)
    60b8:	e456                	sd	s5,8(sp)
    60ba:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    60bc:	0000b797          	auipc	a5,0xb
    60c0:	f5c78793          	add	a5,a5,-164 # 11018 <base>
    60c4:	00004717          	auipc	a4,0x4
    60c8:	72f73623          	sd	a5,1836(a4) # a7f0 <freep>
    60cc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    60ce:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    60d2:	b7c1                	j	6092 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    60d4:	6398                	ld	a4,0(a5)
    60d6:	e118                	sd	a4,0(a0)
    60d8:	a08d                	j	613a <malloc+0xde>
  hp->s.size = nu;
    60da:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60de:	0541                	add	a0,a0,16
    60e0:	00000097          	auipc	ra,0x0
    60e4:	efa080e7          	jalr	-262(ra) # 5fda <free>
  return freep;
    60e8:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60ec:	c13d                	beqz	a0,6152 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60ee:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60f0:	4798                	lw	a4,8(a5)
    60f2:	02977463          	bgeu	a4,s1,611a <malloc+0xbe>
    if(p == freep)
    60f6:	00093703          	ld	a4,0(s2)
    60fa:	853e                	mv	a0,a5
    60fc:	fef719e3          	bne	a4,a5,60ee <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    6100:	8552                	mv	a0,s4
    6102:	00000097          	auipc	ra,0x0
    6106:	bb2080e7          	jalr	-1102(ra) # 5cb4 <sbrk>
  if(p == (char*)-1)
    610a:	fd5518e3          	bne	a0,s5,60da <malloc+0x7e>
        return 0;
    610e:	4501                	li	a0,0
    6110:	7902                	ld	s2,32(sp)
    6112:	6a42                	ld	s4,16(sp)
    6114:	6aa2                	ld	s5,8(sp)
    6116:	6b02                	ld	s6,0(sp)
    6118:	a03d                	j	6146 <malloc+0xea>
    611a:	7902                	ld	s2,32(sp)
    611c:	6a42                	ld	s4,16(sp)
    611e:	6aa2                	ld	s5,8(sp)
    6120:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    6122:	fae489e3          	beq	s1,a4,60d4 <malloc+0x78>
        p->s.size -= nunits;
    6126:	4137073b          	subw	a4,a4,s3
    612a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    612c:	02071693          	sll	a3,a4,0x20
    6130:	01c6d713          	srl	a4,a3,0x1c
    6134:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6136:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    613a:	00004717          	auipc	a4,0x4
    613e:	6aa73b23          	sd	a0,1718(a4) # a7f0 <freep>
      return (void*)(p + 1);
    6142:	01078513          	add	a0,a5,16
  }
}
    6146:	70e2                	ld	ra,56(sp)
    6148:	7442                	ld	s0,48(sp)
    614a:	74a2                	ld	s1,40(sp)
    614c:	69e2                	ld	s3,24(sp)
    614e:	6121                	add	sp,sp,64
    6150:	8082                	ret
    6152:	7902                	ld	s2,32(sp)
    6154:	6a42                	ld	s4,16(sp)
    6156:	6aa2                	ld	s5,8(sp)
    6158:	6b02                	ld	s6,0(sp)
    615a:	b7f5                	j	6146 <malloc+0xea>

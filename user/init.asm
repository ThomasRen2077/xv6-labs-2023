...
main(void)
{
  ...
  12:	8a250513          	add	a0,a0,-1886 # 8b0 <malloc+0x102>
  ...
  3a:	88290913          	add	s2,s2,-1918 # 8b8 <malloc+0x10a>
  3e:	854a                	mv	a0,s2
  ...
  6e:	89e50513          	add	a0,a0,-1890 # 908 <malloc+0x15a>
  ...
  8c:	82850513          	add	a0,a0,-2008 # 8b0 <malloc+0x102>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	81650513          	add	a0,a0,-2026 # 8b0 <malloc+0x102>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	82450513          	add	a0,a0,-2012 # 8d0 <malloc+0x122>
  ...
  d2:	81a50513          	add	a0,a0,-2022 # 8e8 <malloc+0x13a>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	81250513          	add	a0,a0,-2030 # 8f0 <malloc+0x142>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 472:	51a50513          	add	a0,a0,1306 # 988 <digits>
 476:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 578:	3bc70713          	add	a4,a4,956 # 930 <malloc+0x182>
 ...
 604:	388b8b93          	add	s7,s7,904 # 988 <digits>
 ...
 65a:	2d290913          	add	s2,s2,722 # 928 <malloc+0x17a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7fe:	bf690913          	add	s2,s2,-1034 # 13f0 <freep>
  if(p == (char*)-1)
 802:	5afd                	li	s5,-1
 ...
 812:	bf278793          	add	a5,a5,-1038 # 1400 <base>

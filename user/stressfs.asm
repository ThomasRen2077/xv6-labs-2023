...
main(int argc, char *argv[])
{
  ...
  1a:	8fa78793          	add	a5,a5,-1798 # 910 <malloc+0x138>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8b450513          	add	a0,a0,-1868 # 8e0 <malloc+0x108>
  ...
  6c:	89050513          	add	a0,a0,-1904 # 8f8 <malloc+0x120>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	85250513          	add	a0,a0,-1966 # 908 <malloc+0x130>
...
ugetpid(void)
{
 ...
 394:	17f5                	add	a5,a5,-3 # 3fffffd <base+0x3ffebed>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49c:	4e850513          	add	a0,a0,1256 # 980 <digits>
 4a0:	883a                	mv	a6,a4
 4a2:	2705                	addw	a4,a4,1
 4a4:	02c5f7bb          	remuw	a5,a1,a2
 4a8:	1782                	sll	a5,a5,0x20
 4aa:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a2:	38a70713          	add	a4,a4,906 # 928 <malloc+0x150>
 ...
 62e:	356b8b93          	add	s7,s7,854 # 980 <digits>
 ...
 684:	2a090913          	add	s2,s2,672 # 920 <malloc+0x148>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 828:	bdc90913          	add	s2,s2,-1060 # 1400 <freep>
  if(p == (char*)-1)
 82c:	5afd                	li	s5,-1
 ...
 83c:	bd878793          	add	a5,a5,-1064 # 1410 <base>
